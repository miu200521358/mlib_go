...
func TestIkLink_IsValid(t *testing.T) {
	ikLink := &IkLink{
		BoneIndex: -1,
	}
	if ikLink.IsValid() {
...
func TestIk_IsValid(t *testing.T) {
	ik := &Ik{
		BoneIndex: -1,
	}
	if ik.IsValid() {
...
func TestBone_Copy(t *testing.T) {
	t.Run("Test Copy", func(t *testing.T) {
		...
		if copied.Position == b.Position {
			t.Errorf("Expected copied Position to be a deep copy")
		}
		if copied.TailPosition == b.TailPosition {
			t.Errorf("Expected copied TailPosition to be a deep copy")
		}
		if copied.FixedAxis == b.FixedAxis {
			t.Errorf("Expected copied FixedAxis to be a deep copy")
		}
		if copied.LocalXVector == b.LocalXVector {
			t.Errorf("Expected copied LocalXVector to be a deep copy")
		}
		if copied.LocalZVector == b.LocalZVector {
			t.Errorf("Expected copied LocalZVector to be a deep copy")
		}
		if copied.CorrectedLocalXVector == b.CorrectedLocalXVector {
			t.Errorf("Expected copied CorrectedLocalXVector to be a deep copy")
		}
		if copied.CorrectedLocalYVector == b.CorrectedLocalYVector {
			t.Errorf("Expected copied CorrectedLocalYVector to be a deep copy")
		}
		if copied.CorrectedLocalZVector == b.CorrectedLocalZVector {
			t.Errorf("Expected copied CorrectedLocalZVector to be a deep copy")
		}
		if copied.LocalAxis == b.LocalAxis {
			t.Errorf("Expected copied LocalAxis to be a deep copy")
		}
		if copied.LocalMatrix == b.LocalMatrix {
			t.Errorf("Expected copied LocalMatrix to be a deep copy")
		}
		if copied.ParentRelativePosition == b.ParentRelativePosition {
			t.Errorf("Expected copied ParentRelativePosition to be a deep copy")
		}
		if copied.TailRelativePosition == b.TailRelativePosition {
			t.Errorf("Expected copied TailRelativePosition to be a deep copy")
		}
		if copied.CorrectedFixedAxis == b.CorrectedFixedAxis {
			t.Errorf("Expected copied CorrectedFixedAxis to be a deep copy")
		}
		if len(copied.IkLinkIndexes) != len(b.IkLinkIndexes) {
			t.Errorf("Expected copied IkLinkIndexes to have the same length as original")
		}
		if len(copied.IkTargetIndexes) != len(b.IkTargetIndexes) {
			t.Errorf("Expected copied IkTargetIndexes to have the same length as original")
		}
		if len(copied.TreeIndexes) != len(b.TreeIndexes) {
		...
		if len(copied.EffectiveTargetIndexes) != len(b.EffectiveTargetIndexes) {
			t.Errorf("Expected copied EffectiveTargetIndexes to have the same length as original")
		}
