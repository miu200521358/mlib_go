...
func TestBone_Copy(t *testing.T) {
	t.Run("Test Copy", func(t *testing.T) {
		b := &Bone{
			...
			IkLinkBoneIndexes:      []mcore.Int{1, 3, 5},
			IkTargetBoneIndexes:    []mcore.Int{2, 4, 6},
			TreeBoneIndexes:        []mcore.Int{3, 5, 7},
			RevertOffsetMatrix:     &mmath.MMat4{},
			OffsetMatrix:           &mmath.MMat4{},
			RelativeBoneIndexes:    []mcore.Int{8, 9, 10},
			ChildBoneIndexes:       []mcore.Int{10, 11, 12},
			EffectiveBoneIndexes:   []mcore.Int{16, 17, 18},
