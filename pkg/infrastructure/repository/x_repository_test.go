...
func TestXRepository_Load1(t *testing.T) {
	...
	pmxPath := "D:/MMD/MikuMikuDance_v926x64/UserFile/Accessory/咲音マイク.pmx"
...
func TestXRepository_Load2(t *testing.T) {
	...
	// Test case 1: Successful read
	path := "D:/MMD/MikuMikuDance_v926x64/UserFile/Accessory/食べ物/かき氷セットver1.0 キャベツ鉢/かき氷/かき氷コーラ20160619.x"
	data, err := rep.Load(path)
	...
	pmxPath := "D:/MMD/MikuMikuDance_v926x64/UserFile/Accessory/食べ物/かき氷セットver1.0 キャベツ鉢/かき氷/かき氷コーラ20160619.pmx"
	expectedData, _ := pmxRep.Load(pmxPath)
	expectedModel := expectedData.(*pmx.PmxModel)
...
func TestXRepository_Load4(t *testing.T) {
	...
	pmxPath := "D:/MMD/MikuMikuDance_v926x64/UserFile/Accessory/食べ物/お箸セット1 モノゾフ/みやこ箸.pmx"
	expectedData, _ := pmxRep.Load(pmxPath)
	expectedModel := expectedData.(*pmx.PmxModel)
