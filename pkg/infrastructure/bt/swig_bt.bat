swig -c++ -go -cgo -I"C:\MMD\mlib_go\pkg\infrastructure\bt" ^
    ...
    -cpperraswarn -o "C:\MMD\mlib_go\pkg\infrastructure\bt\bt.cxx" "C:\MMD\mlib_go\pkg\infrastructure\bt\bullet.i"
