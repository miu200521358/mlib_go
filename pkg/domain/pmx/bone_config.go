	...
	configOnce.Do(func() {
		standardBoneConfigs = map[StandardBoneNames]*BoneConfig{
			...
			LOWER: NewBoneConfig(LOWER,
				...
				[]BoneCategory{CATEGORY_LOWER, CATEGORY_FITTING_MOVE, CATEGORY_FITTING_ROTATE, CATEGORY_FITTING_SCALE}),
			...
			UPPER: NewBoneConfig(UPPER,
				...
				[]BoneCategory{CATEGORY_UPPER, CATEGORY_FITTING_MOVE, CATEGORY_FITTING_ROTATE, CATEGORY_FITTING_SCALE}),
			UPPER2: NewBoneConfig(UPPER2,
				[]StandardBoneNames{UPPER},
				mmath.MVec3UnitY,
				[]StandardBoneNames{NECK_ROOT},
				BoneFlag(BONE_FLAG_CAN_ROTATE|BONE_FLAG_CAN_MANIPULATE|BONE_FLAG_IS_VISIBLE|BONE_FLAG_TAIL_IS_BONE),
				[]BoneCategory{CATEGORY_UPPER, CATEGORY_FITTING_ROTATE, CATEGORY_FITTING_SCALE}),
			NECK_ROOT: NewBoneConfig(NECK_ROOT,
				[]StandardBoneNames{UPPER2, UPPER},
				mmath.MVec3UnitY,
				[]StandardBoneNames{NECK},
				BoneFlag(BONE_FLAG_CAN_ROTATE|BONE_FLAG_CAN_MANIPULATE|BONE_FLAG_IS_VISIBLE),
				[]BoneCategory{CATEGORY_UPPER, CATEGORY_FITTING_ROTATE}),
			NECK: NewBoneConfig(NECK,
				[]StandardBoneNames{NECK_ROOT, UPPER2, UPPER},
				mmath.MVec3UnitY,
				[]StandardBoneNames{HEAD},
				BoneFlag(BONE_FLAG_CAN_ROTATE|BONE_FLAG_CAN_MANIPULATE|BONE_FLAG_IS_VISIBLE|BONE_FLAG_TAIL_IS_BONE),
				[]BoneCategory{CATEGORY_UPPER, CATEGORY_HEAD, CATEGORY_FITTING_ROTATE, CATEGORY_FITTING_SCALE}),
			HEAD: NewBoneConfig(HEAD,
				[]StandardBoneNames{NECK},
				mmath.MVec3UnitY,
				[]StandardBoneNames{},
				BoneFlag(BONE_FLAG_CAN_ROTATE|BONE_FLAG_CAN_MANIPULATE|BONE_FLAG_IS_VISIBLE),
				[]BoneCategory{CATEGORY_UPPER, CATEGORY_HEAD, CATEGORY_FITTING_SCALE}),
			...
			SHOULDER: NewBoneConfig(SHOULDER,
				...
				BoneFlag(BONE_FLAG_CAN_ROTATE|BONE_FLAG_CAN_MANIPULATE|BONE_FLAG_IS_VISIBLE|BONE_FLAG_TAIL_IS_BONE),
				[]BoneCategory{CATEGORY_UPPER, CATEGORY_ARM, CATEGORY_FITTING_ROTATE, CATEGORY_FITTING_SCALE}),
			...
			ARM_TWIST: NewBoneConfig(ARM_TWIST,
				...
				[]BoneCategory{CATEGORY_UPPER, CATEGORY_ARM, CATEGORY_TWIST, CATEGORY_FITTING_ROTATE, CATEGORY_FITTING_SCALE}),
			...
			THUMB0: NewBoneConfig(THUMB0,
				...
				[]BoneCategory{CATEGORY_UPPER, CATEGORY_ARM, CATEGORY_FINGER, CATEGORY_FITTING_ROTATE, CATEGORY_FITTING_SCALE}),
			...
			LEG: NewBoneConfig(LEG,
				...
				BoneFlag(BONE_FLAG_CAN_ROTATE|BONE_FLAG_CAN_MANIPULATE|BONE_FLAG_IS_VISIBLE|BONE_FLAG_TAIL_IS_BONE),
				[]BoneCategory{CATEGORY_LOWER, CATEGORY_LEG, CATEGORY_LEG_FK, CATEGORY_FITTING_ROTATE, CATEGORY_FITTING_SCALE}),
			...
			ANKLE: NewBoneConfig(ANKLE,
				...
				BoneFlag(BONE_FLAG_CAN_ROTATE|BONE_FLAG_CAN_MANIPULATE|BONE_FLAG_IS_VISIBLE|BONE_FLAG_TAIL_IS_BONE),
				[]BoneCategory{CATEGORY_LOWER, CATEGORY_LEG, CATEGORY_LEG_FK, CATEGORY_ANKLE, CATEGORY_FITTING_ROTATE, CATEGORY_FITTING_SCALE}),
			...
			LEG_D: NewBoneConfig(LEG_D,
				...
				BoneFlag(BONE_FLAG_CAN_ROTATE|BONE_FLAG_CAN_MANIPULATE|BONE_FLAG_IS_VISIBLE|BONE_FLAG_TAIL_IS_BONE),
				[]BoneCategory{CATEGORY_LOWER, CATEGORY_LEG, CATEGORY_LEG_D, CATEGORY_FITTING_ROTATE, CATEGORY_FITTING_SCALE}),
			...
			ANKLE_D: NewBoneConfig(ANKLE_D,
				...
				BoneFlag(BONE_FLAG_CAN_ROTATE|BONE_FLAG_CAN_MANIPULATE|BONE_FLAG_IS_VISIBLE|BONE_FLAG_TAIL_IS_BONE),
				[]BoneCategory{CATEGORY_LOWER, CATEGORY_LEG, CATEGORY_LEG_D, CATEGORY_ANKLE, CATEGORY_FITTING_ROTATE, CATEGORY_FITTING_SCALE}),
