	...
	configOnce.Do(func() {
		standardBoneConfigs = map[StandardBoneNames]*BoneConfig{
			...
			LOWER: NewBoneConfig(LOWER,
				...
				[]BoneCategory{CATEGORY_LOWER, CATEGORY_FITTING_LOCAL_ROTATE, CATEGORY_FITTING_LOCAL_SCALE}),
			...
			HEEL: NewBoneConfig(HEEL,
				...
				BoneFlag(BONE_FLAG_CAN_ROTATE|BONE_FLAG_CAN_MANIPULATE|BONE_FLAG_IS_VISIBLE|BONE_FLAG_TAIL_IS_BONE),
				[]BoneCategory{CATEGORY_LOWER, CATEGORY_LEG, CATEGORY_LEG_D, CATEGORY_ANKLE, CATEGORY_SOLE, CATEGORY_FITTING_LOCAL_MOVE}),
			...
			LEG_IK: NewBoneConfig(LEG_IK,
				...
				[]BoneCategory{CATEGORY_LOWER, CATEGORY_FITTING_LOCAL_MOVE}),
