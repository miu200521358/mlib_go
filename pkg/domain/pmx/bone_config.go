...
const (
	...
	CATEGORY_FITTING_LOCAL_MATRIX BoneCategory = iota
)
	...
	configOnce.Do(func() {
		standardBoneConfigs = map[StandardBoneNames]*BoneConfig{
			...
			UPPER: {
				...
				UpFromBoneNames: []StandardBoneNames{StandardBoneNames(ARM.Left())},
				UpToBoneNames:   []StandardBoneNames{StandardBoneNames(ARM.Right())},
				Categories:      []BoneCategory{CATEGORY_UPPER}},
			UPPER2: {
			...
			HEAD: {
				...
				ChildBoneNames:  []StandardBoneNames{},
				UpFromBoneNames: []StandardBoneNames{StandardBoneNames(EYE.Left())},
				UpToBoneNames:   []StandardBoneNames{StandardBoneNames(EYE.Right())},
			...
			ELBOW: {
				...
				UpFromBoneNames: []StandardBoneNames{ARM},
				UpToBoneNames:   []StandardBoneNames{ELBOW},
				Categories:      []BoneCategory{CATEGORY_UPPER, CATEGORY_ARM}},
			WRIST_TWIST: {
			...
			ANKLE: {
				...
				Categories:      []BoneCategory{CATEGORY_LOWER, CATEGORY_LEG, CATEGORY_LEG_FK, CATEGORY_ANKLE, CATEGORY_FITTING_SCALE}},
			HEEL: {
			...
			ANKLE_D: {
				...
				Categories:      []BoneCategory{CATEGORY_LOWER, CATEGORY_LEG, CATEGORY_LEG_D, CATEGORY_ANKLE, CATEGORY_FITTING_SCALE}},
			HEEL_D: {
			...
			LEG_IK_PARENT: {
				...
				UpFromBoneNames: []StandardBoneNames{},
				UpToBoneNames:   []StandardBoneNames{},
				Categories:      []BoneCategory{CATEGORY_LOWER, CATEGORY_SOLE}},
			LEG_IK: {
