	...
	configOnce.Do(func() {
		standardBoneConfigs = map[StandardBoneNames]*BoneConfig{
			ROOT: {
				...
				UpFromBoneNames: []StandardBoneNames{},
				UpToBoneNames:   []StandardBoneNames{},
				Categories:      []BoneCategory{CATEGORY_ROOT, CATEGORY_FITTING_MOVE}},
			CENTER: {
			...
			LOWER_ROOT: {
				...
				UpFromBoneNames: []StandardBoneNames{},
				UpToBoneNames:   []StandardBoneNames{},
				Categories:      []BoneCategory{CATEGORY_LOWER, CATEGORY_FITTING_ROTATE}},
			LOWER: {
			...
			UPPER_ROOT: {
				...
				UpFromBoneNames: []StandardBoneNames{},
				UpToBoneNames:   []StandardBoneNames{},
				Categories:      []BoneCategory{CATEGORY_UPPER, CATEGORY_FITTING_ROTATE}},
			UPPER: {
			...
			HEAD: {
				...
				Categories:      []BoneCategory{CATEGORY_UPPER, CATEGORY_HEAD, CATEGORY_FITTING_MOVE}},
			EYES: {
			...
			SHOULDER_ROOT: {
				...
				Categories:      []BoneCategory{CATEGORY_UPPER, CATEGORY_ARM, CATEGORY_FITTING_ROTATE}},
			SHOULDER_P: {
			...
			ARM_TWIST: {
				...
				UpFromBoneNames: []StandardBoneNames{SHOULDER},
				UpToBoneNames:   []StandardBoneNames{ARM},
				Categories:      []BoneCategory{CATEGORY_UPPER, CATEGORY_ARM, CATEGORY_TWIST, CATEGORY_FITTING_ROTATE}},
			ARM_TWIST1: {
				ParentBoneNames: []StandardBoneNames{ARM},
				ChildBoneNames:  []StandardBoneNames{ELBOW},
				UpFromBoneNames: []StandardBoneNames{},
			...
			THUMB0: {
				...
				Categories:      []BoneCategory{CATEGORY_UPPER, CATEGORY_ARM, CATEGORY_FINGER, CATEGORY_FITTING_ROTATE}},
			THUMB1: {
			...
			LEG_ROOT: {
				...
				Categories:      []BoneCategory{CATEGORY_LOWER, CATEGORY_LEG, CATEGORY_FITTING_ROTATE}},
			WAIST_CANCEL: {
			...
			LEG: {
				...
				UpFromBoneNames: []StandardBoneNames{},
				UpToBoneNames:   []StandardBoneNames{},
				Categories:      []BoneCategory{CATEGORY_LOWER, CATEGORY_LEG, CATEGORY_LEG_FK, CATEGORY_FITTING_ROTATE}},
			KNEE: {
			...
			ANKLE: {
				...
				Categories:      []BoneCategory{CATEGORY_LOWER, CATEGORY_LEG, CATEGORY_LEG_FK, CATEGORY_ANKLE, CATEGORY_FITTING_SCALE, CATEGORY_FITTING_ROTATE}},
			HEEL: {
				ParentBoneNames: []StandardBoneNames{ANKLE},
				ChildBoneNames:  []StandardBoneNames{TOE},
				UpFromBoneNames: []StandardBoneNames{TOE_P},
				UpToBoneNames:   []StandardBoneNames{TOE_C},
				Categories:      []BoneCategory{CATEGORY_LOWER, CATEGORY_LEG, CATEGORY_LEG_D, CATEGORY_ANKLE, CATEGORY_SOLE, CATEGORY_FITTING_ROTATE}},
			TOE: {
				ParentBoneNames: []StandardBoneNames{ANKLE},
				ChildBoneNames:  []StandardBoneNames{TOE_P},
				UpFromBoneNames: []StandardBoneNames{},
				UpToBoneNames:   []StandardBoneNames{},
				Categories:      []BoneCategory{CATEGORY_LOWER, CATEGORY_LEG, CATEGORY_LEG_FK, CATEGORY_ANKLE, CATEGORY_SOLE, CATEGORY_FITTING_ROTATE}},
			TOE_P: {
			...
			LEG_D: {
				...
				UpFromBoneNames: []StandardBoneNames{},
				UpToBoneNames:   []StandardBoneNames{},
				Categories:      []BoneCategory{CATEGORY_LOWER, CATEGORY_LEG, CATEGORY_LEG_D, CATEGORY_FITTING_ROTATE}},
			KNEE_D: {
				ParentBoneNames: []StandardBoneNames{LEG},
			...
			ANKLE_D: {
				...
				Categories:      []BoneCategory{CATEGORY_LOWER, CATEGORY_LEG, CATEGORY_LEG_D, CATEGORY_ANKLE, CATEGORY_FITTING_SCALE, CATEGORY_FITTING_ROTATE}},
			HEEL_D: {
			...
			LEG_IK_PARENT: {
				...
				UpFromBoneNames: []StandardBoneNames{},
				UpToBoneNames:   []StandardBoneNames{},
				Categories:      []BoneCategory{CATEGORY_LOWER, CATEGORY_SOLE, CATEGORY_FITTING_MOVE}},
			LEG_IK: {
				ParentBoneNames: []StandardBoneNames{LEG_IK_PARENT, ROOT},
				ChildBoneNames:  []StandardBoneNames{TOE_IK},
				UpFromBoneNames: []StandardBoneNames{},
				UpToBoneNames:   []StandardBoneNames{},
				Categories:      []BoneCategory{CATEGORY_LOWER, CATEGORY_FITTING_MOVE}},
			TOE_IK: {
