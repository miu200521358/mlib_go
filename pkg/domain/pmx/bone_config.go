...
const (
	...
	// ローカル変形時に親の変形を引き継ぐか
	CATEGORY_INHERIT_PARENT BoneCategory = iota
)
	...
	configOnce.Do(func() {
		standardBoneConfigs = map[StandardBoneNames]*BoneConfig{
			...
			ARM_TWIST: NewBoneConfig(ARM_TWIST,
				...
				[]BoneCategory{CATEGORY_UPPER, CATEGORY_ARM, CATEGORY_TWIST, CATEGORY_FITTING_LOCAL_ROTATE, CATEGORY_FITTING_LOCAL_SCALE, CATEGORY_INHERIT_PARENT}),
			...
			ANKLE: NewBoneConfig(ANKLE,
				...
				BoneFlag(BONE_FLAG_CAN_ROTATE|BONE_FLAG_CAN_MANIPULATE|BONE_FLAG_IS_VISIBLE|BONE_FLAG_TAIL_IS_BONE),
				[]BoneCategory{CATEGORY_LOWER, CATEGORY_LEG, CATEGORY_LEG_FK, CATEGORY_ANKLE, CATEGORY_FITTING_LOCAL_ROTATE, CATEGORY_FITTING_LOCAL_SCALE}),
