...
const (
	...
	// フィッティングの時にキャンセル付き移動させるか
	CATEGORY_FITTING_CANCELABLE_MOVE BoneCategory = iota
	// フィッティングの時にキャンセル付き回転させるか
	CATEGORY_FITTING_CANCELABLE_ROTATE BoneCategory = iota
	// フィッティングの時にキャンセル付きスケールさせるか
	CATEGORY_FITTING_CANCELABLE_SCALE BoneCategory = iota
	// フィッティングの時にローカル行列移動を適用するか
	CATEGORY_FITTING_LOCAL_MATRIX_TRANSLATE BoneCategory = iota
	// フィッティングの時にローカル行列回転を適用するか
	CATEGORY_FITTING_LOCAL_MATRIX_ROTATE BoneCategory = iota
	// フィッティングの時にローカル行列スケールを適用するか
	CATEGORY_FITTING_LOCAL_MATRIX_SCALE BoneCategory = iota
)
	...
	configOnce.Do(func() {
		standardBoneConfigs = map[StandardBoneNames]*BoneConfig{
			...
			CENTER: NewBoneConfig(CENTER,
				...
				mmath.MVec3UnitY,
				[]StandardBoneNames{GROOVE, WAIST, WAIST_CENTER, UPPER, LOWER},
				BoneFlag(BONE_FLAG_CAN_ROTATE|BONE_FLAG_CAN_TRANSLATE|BONE_FLAG_CAN_MANIPULATE|BONE_FLAG_IS_VISIBLE),
				[]BoneCategory{CATEGORY_ROOT, CATEGORY_FITTING_CANCELABLE_MOVE}),
			GROOVE: NewBoneConfig(GROOVE,
				[]StandardBoneNames{CENTER},
				&mmath.MVec3{X: 0, Y: -1, Z: 0},
				[]StandardBoneNames{WAIST, WAIST_CENTER, UPPER, LOWER},
				BoneFlag(BONE_FLAG_CAN_ROTATE|BONE_FLAG_CAN_TRANSLATE|BONE_FLAG_CAN_MANIPULATE|BONE_FLAG_IS_VISIBLE),
				[]BoneCategory{CATEGORY_ROOT, CATEGORY_FITTING_CANCELABLE_MOVE}),
			WAIST: NewBoneConfig(WAIST,
				[]StandardBoneNames{GROOVE, CENTER},
				&mmath.MVec3{X: 0, Y: -1, Z: 0},
				[]StandardBoneNames{WAIST_CENTER, UPPER, LOWER},
				BoneFlag(BONE_FLAG_CAN_ROTATE|BONE_FLAG_CAN_TRANSLATE|BONE_FLAG_CAN_MANIPULATE|BONE_FLAG_IS_VISIBLE),
				[]BoneCategory{CATEGORY_ROOT, CATEGORY_FITTING_CANCELABLE_MOVE}),
			WAIST_CENTER: NewBoneConfig(WAIST_CENTER,
				[]StandardBoneNames{WAIST, GROOVE, CENTER},
				&mmath.MVec3{X: 0, Y: -1, Z: 0},
				[]StandardBoneNames{UPPER, LOWER},
				BoneFlag(BONE_FLAG_CAN_ROTATE|BONE_FLAG_CAN_TRANSLATE|BONE_FLAG_CAN_MANIPULATE|BONE_FLAG_IS_VISIBLE),
				[]BoneCategory{CATEGORY_ROOT, CATEGORY_FITTING_MOVE}),
			LOWER: NewBoneConfig(LOWER,
				[]StandardBoneNames{WAIST_CENTER, WAIST, GROOVE, CENTER},
				&mmath.MVec3{X: 0, Y: -1, Z: 0},
				[]StandardBoneNames{LEG_CENTER},
				BoneFlag(BONE_FLAG_CAN_ROTATE|BONE_FLAG_CAN_MANIPULATE|BONE_FLAG_IS_VISIBLE),
				[]BoneCategory{CATEGORY_LOWER, CATEGORY_FITTING_LOCAL_MATRIX_ROTATE, CATEGORY_FITTING_LOCAL_MATRIX_SCALE}),
			UPPER: NewBoneConfig(UPPER,
				...
				[]BoneCategory{CATEGORY_UPPER, CATEGORY_FITTING_LOCAL_MATRIX_ROTATE, CATEGORY_FITTING_LOCAL_MATRIX_SCALE}),
			...
			HEAD: NewBoneConfig(HEAD,
				...
				[]StandardBoneNames{},
				BoneFlag(BONE_FLAG_CAN_ROTATE|BONE_FLAG_CAN_MANIPULATE|BONE_FLAG_IS_VISIBLE),
				[]BoneCategory{CATEGORY_UPPER, CATEGORY_HEAD, CATEGORY_FITTING_LOCAL_MATRIX_ROTATE, CATEGORY_FITTING_SCALE}),
			...
			SHOULDER_ROOT: NewBoneConfig(SHOULDER_ROOT,
				[]StandardBoneNames{NECK_ROOT},
				mmath.MVec3UnitY,
				[]StandardBoneNames{SHOULDER_P},
				BoneFlag(BONE_FLAG_CAN_ROTATE|BONE_FLAG_IS_VISIBLE),
				[]BoneCategory{CATEGORY_UPPER, CATEGORY_ARM, CATEGORY_FITTING_LOCAL_MATRIX_ROTATE, CATEGORY_FITTING_LOCAL_MATRIX_SCALE}),
			...
			ARM_TWIST: NewBoneConfig(ARM_TWIST,
				...
				[]BoneCategory{CATEGORY_UPPER, CATEGORY_ARM, CATEGORY_TWIST, CATEGORY_FITTING_LOCAL_MATRIX_ROTATE, CATEGORY_FITTING_LOCAL_MATRIX_SCALE}),
			...
			THUMB0: NewBoneConfig(THUMB0,
				...
				[]BoneCategory{CATEGORY_UPPER, CATEGORY_ARM, CATEGORY_FINGER, CATEGORY_FITTING_LOCAL_MATRIX_ROTATE, CATEGORY_FITTING_LOCAL_MATRIX_SCALE}),
			...
			LEG_ROOT: NewBoneConfig(LEG_ROOT,
				...
				BoneFlag(BONE_FLAG_CAN_ROTATE|BONE_FLAG_CAN_MANIPULATE|BONE_FLAG_IS_VISIBLE|BONE_FLAG_TAIL_IS_BONE),
				[]BoneCategory{CATEGORY_LOWER, CATEGORY_FITTING_LOCAL_MATRIX_SCALE}),
			...
			LEG: NewBoneConfig(LEG,
				...
				BoneFlag(BONE_FLAG_CAN_ROTATE|BONE_FLAG_CAN_MANIPULATE|BONE_FLAG_IS_VISIBLE|BONE_FLAG_TAIL_IS_BONE),
				[]BoneCategory{CATEGORY_LOWER, CATEGORY_LEG, CATEGORY_LEG_FK, CATEGORY_FITTING_LOCAL_MATRIX_ROTATE, CATEGORY_FITTING_LOCAL_MATRIX_SCALE}),
			...
			HEEL: NewBoneConfig(HEEL,
				...
				BoneFlag(BONE_FLAG_CAN_ROTATE|BONE_FLAG_CAN_MANIPULATE|BONE_FLAG_IS_VISIBLE|BONE_FLAG_TAIL_IS_BONE),
				[]BoneCategory{CATEGORY_LOWER, CATEGORY_LEG, CATEGORY_LEG_D, CATEGORY_ANKLE, CATEGORY_SOLE, CATEGORY_FITTING_CANCELABLE_MOVE}),
			TOE: NewBoneConfig(TOE,
				[]StandardBoneNames{ANKLE},
				&mmath.MVec3{X: 0, Y: -1, Z: 0},
				[]StandardBoneNames{},
				BoneFlag(BONE_FLAG_CAN_ROTATE|BONE_FLAG_CAN_MANIPULATE|BONE_FLAG_IS_VISIBLE),
				[]BoneCategory{CATEGORY_LOWER, CATEGORY_LEG, CATEGORY_LEG_FK, CATEGORY_ANKLE, CATEGORY_SOLE}),
			LEG_D: NewBoneConfig(LEG_D,
				[]StandardBoneNames{LEG_CENTER, LOWER},
				&mmath.MVec3{X: 0, Y: -1, Z: 0},
				[]StandardBoneNames{KNEE_D},
				BoneFlag(BONE_FLAG_CAN_ROTATE|BONE_FLAG_CAN_MANIPULATE|BONE_FLAG_IS_VISIBLE|BONE_FLAG_TAIL_IS_BONE),
				[]BoneCategory{CATEGORY_LOWER, CATEGORY_LEG, CATEGORY_LEG_D, CATEGORY_FITTING_LOCAL_MATRIX_ROTATE, CATEGORY_FITTING_LOCAL_MATRIX_SCALE}),
			...
			LEG_IK_PARENT: NewBoneConfig(LEG_IK_PARENT,
				...
				BoneFlag(BONE_FLAG_CAN_ROTATE|BONE_FLAG_CAN_TRANSLATE|BONE_FLAG_CAN_MANIPULATE|BONE_FLAG_IS_VISIBLE),
				[]BoneCategory{CATEGORY_LOWER, CATEGORY_SOLE, CATEGORY_FITTING_CANCELABLE_MOVE}),
			LEG_IK: NewBoneConfig(LEG_IK,
				...
				[]BoneCategory{CATEGORY_LOWER, CATEGORY_FITTING_CANCELABLE_MOVE}),
