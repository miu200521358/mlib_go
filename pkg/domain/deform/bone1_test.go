...
func TestVmdMotion_Deform_Exists(t *testing.T) {
	...
	model := loadPmx(t, "../../../internal/test_resources/サンプルモデル.pmx")

	{

		boneDeltas, _ := computeBoneDeltas(model, vmdMotion, motion.Frame(10), []string{pmxNames.INDEX3.Left()}, false, false, false)
		{
			expectedPosition := vec3(0.0, 0.0, 0.0)
			if !boneDeltas.GetByName(pmxNames.ROOT.String()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.ROOT.String()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.ROOT.String()).FilledGlobalPosition()))
			}
		}
		{
			expectedPosition := vec3(0.044920, 8.218059, 0.069347)
			if !boneDeltas.GetByName(pmxNames.CENTER.String()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.CENTER.String()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.CENTER.String()).FilledGlobalPosition()))
			}
		}
		{
			expectedPosition := vec3(0.044920, 9.392067, 0.064877)
			if !boneDeltas.GetByName(pmxNames.GROOVE.String()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.GROOVE.String()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.GROOVE.String()).FilledGlobalPosition()))
			}
		}
		{
			expectedPosition := vec3(0.044920, 11.740084, 0.055937)
			if !boneDeltas.GetByName(pmxNames.WAIST.String()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.WAIST.String()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.WAIST.String()).FilledGlobalPosition()))
			}
		}
		{
			expectedPosition := vec3(0.044920, 12.390969, -0.100531)
			if !boneDeltas.GetByName(pmxNames.UPPER.String()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.UPPER.String()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.UPPER.String()).FilledGlobalPosition()))
			}
		}
		{
			expectedPosition := vec3(0.044920, 13.803633, -0.138654)
			if !boneDeltas.GetByName(pmxNames.UPPER2.String()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.UPPER2.String()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.UPPER2.String()).FilledGlobalPosition()))
			}
		}
		{
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmxNames.SHOULDER_P.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.SHOULDER_P.Left()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.SHOULDER_P.Left()).FilledGlobalPosition()))
			}
		}
		{
			expectedPosition := vec3(0.324862, 16.470263, 0.419041)
			if !boneDeltas.GetByName(pmxNames.SHOULDER.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.SHOULDER.Left()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.SHOULDER.Left()).FilledGlobalPosition()))
			}
		}
		{
			expectedPosition := vec3(1.369838, 16.312170, 0.676838)
			if !boneDeltas.GetByName(pmxNames.ARM.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.ARM.Left()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.ARM.Left()).FilledGlobalPosition()))
			}
		}
		{
			expectedPosition := vec3(1.845001, 15.024807, 0.747681)
			if !boneDeltas.GetByName(pmxNames.ARM_TWIST.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.ARM_TWIST.Left()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.ARM_TWIST.Left()).FilledGlobalPosition()))
			}
		}
		{
			expectedPosition := vec3(2.320162, 13.737446, 0.818525)
			if !boneDeltas.GetByName(pmxNames.ELBOW.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.ELBOW.Left()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.ELBOW.Left()).FilledGlobalPosition()))
			}
		}
		{
			expectedPosition := vec3(2.526190, 12.502445, 0.336127)
			if !boneDeltas.GetByName(pmxNames.WRIST_TWIST.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.WRIST_TWIST.Left()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.WRIST_TWIST.Left()).FilledGlobalPosition()))
			}
		}
		{
			expectedPosition := vec3(2.732219, 11.267447, -0.146273)
			if !boneDeltas.GetByName(pmxNames.WRIST.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.WRIST.Left()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.WRIST.Left()).FilledGlobalPosition()))
			}
		}
		{
			expectedPosition := vec3(2.649188, 10.546797, -0.607412)
			if !boneDeltas.GetByName(pmxNames.INDEX1.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.INDEX1.Left()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.INDEX1.Left()).FilledGlobalPosition()))
			}
		}
		{
			expectedPosition := vec3(2.408238, 10.209290, -0.576288)
			if !boneDeltas.GetByName(pmxNames.INDEX2.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.INDEX2.Left()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.INDEX2.Left()).FilledGlobalPosition()))
			}
		}
		{
			expectedPosition := vec3(2.360455, 10.422402, -0.442668)
			if !boneDeltas.GetByName(pmxNames.INDEX3.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.INDEX3.Left()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.INDEX3.Left()).FilledGlobalPosition()))
			}
		}
	}
}
...
func TestVmdMotion_Deform_Lerp(t *testing.T) {
	...
	{
		boneDeltas, _ := computeBoneDeltas(model, vmdMotion, motion.Frame(999), []string{pmxNames.INDEX3.Left()}, true, false, false)
		{
			expectedPosition := vec3(0.0, 0.0, 0.0)
			if !boneDeltas.GetByName(pmxNames.ROOT.String()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.ROOT.String()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.ROOT.String()).FilledGlobalPosition()))
...
func TestVmdMotion_DeformLegIk1_Matsu(t *testing.T) {
	...
	{
		boneDeltas, _ := computeBoneDeltas(model, vmdMotion, motion.Frame(29), []string{"左つま先", pmxNames.HEEL.Left()}, true, false, false)
		{
			expectedPosition := vec3(-0.781335, 11.717622, 1.557067)
			if !boneDeltas.GetByName(pmxNames.LOWER.String()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.LOWER.String()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.LOWER.String()).FilledGlobalPosition()))
			}
		}
		{
			expectedPosition := vec3(-0.368843, 10.614175, 2.532657)
			if !boneDeltas.GetByName(pmxNames.LEG.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.LEG.Left()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.LEG.Left()).FilledGlobalPosition()))
			}
		}
		{
			expectedPosition := vec3(0.983212, 6.945313, 0.487476)
			if !boneDeltas.GetByName(pmxNames.KNEE.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.KNEE.Left()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.KNEE.Left()).FilledGlobalPosition()))
			}
		}
		{
			expectedPosition := vec3(-0.345842, 2.211842, 2.182894)
			if !boneDeltas.GetByName(pmxNames.ANKLE.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.ANKLE.Left()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.ANKLE.Left()).FilledGlobalPosition()))
			}
		}
		{
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmxNames.HEEL.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.HEEL.Left()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.HEEL.Left()).FilledGlobalPosition()))
			}
		}
	}
}
...
func TestVmdMotion_DeformLegIk2_Matsu(t *testing.T) {
	...
	{
		boneDeltas, _ := computeBoneDeltas(model, vmdMotion, motion.Frame(3152), []string{"左つま先", pmxNames.HEEL.Left()}, true, false, false)
		{
...
func TestVmdMotion_DeformLegIk3_Matsu(t *testing.T) {
	...
	{
		boneDeltas, _ := computeBoneDeltas(model, vmdMotion, motion.Frame(60), nil, true, false, false)
		{
		...
		{
			expectedPosition := vec3(2.263363, 7.061642, -3.837192)
			if !boneDeltas.GetByName(pmxNames.KNEE_D.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.KNEE_D.Left()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.KNEE_D.Left()).FilledGlobalPosition()))
			}
		}
		{
			expectedPosition := vec3(1.916109, 1.177077, -1.452845)
			if !boneDeltas.GetByName(pmxNames.TOE_EX.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.TOE_EX.Left()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.TOE_EX.Left()).FilledGlobalPosition()))
			}
		}
		{
...
func TestVmdMotion_DeformLegIk4_Snow(t *testing.T) {
	...
	boneDeltas, _ := computeBoneDeltas(model, vmdMotion, motion.Frame(0), []string{"右つま先", pmxNames.HEEL.Right()}, true, false, false)
	{
	...
	}
	{
		...
		if !boneDeltas.GetByName(pmxNames.LEG.Right()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
			t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.LEG.Right()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.LEG.Right()).FilledGlobalPosition()))
		}
	}
	{
		expectedPosition := vec3(0.950410, 11.256771, -1.589462)
		if !boneDeltas.GetByName(pmxNames.KNEE.Right()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
			t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.KNEE.Right()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.KNEE.Right()).FilledGlobalPosition()))
		}
	}
	{
		expectedPosition := vec3(-1.025194, 7.871110, 1.828258)
		if !boneDeltas.GetByName(pmxNames.ANKLE.Right()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
			t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.ANKLE.Right()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.ANKLE.Right()).FilledGlobalPosition()))
		}
	}
	{
	...
	}
	{
		...
		if !boneDeltas.GetByName(pmxNames.HEEL.Right()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
			t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.HEEL.Right()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.HEEL.Right()).FilledGlobalPosition()))
		}
	}
}
...
func TestVmdMotion_DeformLegIk5_Koshi(t *testing.T) {
	...
	boneDeltas, _ := computeBoneDeltas(model, vmdMotion, motion.Frame(7409), []string{"右つま先", pmxNames.HEEL.Right()}, true, false, false)
	{
...
func TestVmdMotion_DeformLegIk6_KoshiOff(t *testing.T) {
	...
	// IK OFF
	boneDeltas, _ := computeBoneDeltas(model, vmdMotion, motion.Frame(0), nil, false, false, false)
	{
...
func TestVmdMotion_DeformLegIk6_KoshiOn(t *testing.T) {
	...
	// IK ON
	boneDeltas, _ := computeBoneDeltas(model, vmdMotion, motion.Frame(0), nil, true, false, false)
	{
...
func TestVmdMotion_DeformLegIk6_KoshiIkOn(t *testing.T) {
	...
	ikEnabledFrame := motion.NewIkEnabledFrame(motion.Frame(fno), pmxNames.LEG_IK.Left())
...
func TestVmdMotion_DeformLegIk8_Syou(t *testing.T) {
	...
	boneDeltas, _ := computeBoneDeltas(model, vmdMotion, motion.Frame(278), []string{"右つま先", pmxNames.HEEL.Right()}, true, false, false)
	{
		expectedPosition := vec3(0.721499, 11.767294, 1.638818)
		if !boneDeltas.GetByName(pmxNames.LOWER.String()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
			t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.LOWER.String()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.LOWER.String()).FilledGlobalPosition()))
...
func TestVmdMotion_DeformLegIk10_Syou1(t *testing.T) {
	...
	boneDeltas, _ := computeBoneDeltas(model, vmdMotion, motion.Frame(100), []string{"右つま先", pmxNames.HEEL.Right()}, true, false, false)
	{
...
func TestVmdMotion_DeformLegIk10_Syou2(t *testing.T) {
	...
	boneDeltas, _ := computeBoneDeltas(model, vmdMotion, motion.Frame(107), []string{"右つま先", pmxNames.HEEL.Right()}, true, false, false)
	{
...
func TestVmdMotion_DeformLegIk10_Syou3(t *testing.T) {
	...
	boneDeltas, _ := computeBoneDeltas(model, vmdMotion, motion.Frame(272), []string{"右つま先", pmxNames.HEEL.Right()}, true, false, false)
	{
...
func TestVmdMotion_DeformLegIk10_Syou4(t *testing.T) {
	...
	boneDeltas, _ := computeBoneDeltas(model, vmdMotion, motion.Frame(273), []string{"右つま先", pmxNames.HEEL.Right()}, true, false, false)
	{
...
func TestVmdMotion_DeformLegIk10_Syou5(t *testing.T) {
	...
	boneDeltas, _ := computeBoneDeltas(model, vmdMotion, motion.Frame(274), []string{"右つま先", pmxNames.HEEL.Right()}, true, false, false)
	{
...
func TestVmdMotion_DeformLegIk11_Shining_Miku(t *testing.T) {
	...
	boneDeltas, _ := computeBoneDeltas(model, vmdMotion, motion.Frame(0), []string{pmxNames.LEG_IK.Right(), pmxNames.HEEL.Right(), "足首_R_"}, true, false, false)
	{
		expectedPosition := vec3(-1.869911, 2.074591, -0.911531)
		if !boneDeltas.GetByName(pmxNames.LEG_IK.Right()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
			t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.LEG_IK.Right()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.LEG_IK.Right()).FilledGlobalPosition()))
		}
	}
	{
...
func TestVmdMotion_DeformLegIk13_Lamb(t *testing.T) {
	...
	boneDeltas, _ := computeBoneDeltas(model, vmdMotion, motion.Frame(0), []string{pmxNames.LEG_IK.Right(), "右つま先", pmxNames.LEG_IK.Left(), "左つま先", pmxNames.HEEL.Left()}, true, false, false)
	...
	}
	{

		{
			...
			if !boneDeltas.GetByName(pmxNames.LEG_IK.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.LEG_IK.Left()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.LEG_IK.Left()).FilledGlobalPosition()))
			}
		}
		{
			expectedPosition := vec3(0.803149, 6.056844, -10.232766)
...
func TestVmdMotion_DeformLegIk14_Ballet(t *testing.T) {
	...
	boneDeltas, _ := computeBoneDeltas(model, vmdMotion, motion.Frame(0), []string{pmxNames.LEG_IK.Right(), "右つま先", pmxNames.HEEL.Right()}, true, false, false)
	{
...
func TestVmdMotion_DeformLegIk15_Bottom(t *testing.T) {
	...
	boneDeltas, _ := computeBoneDeltas(model, vmdMotion, motion.Frame(218), []string{pmxNames.LEG_IK.Right(), pmxNames.HEEL.Right(), "足首_R_"}, true, false, false)
	{
...
func TestVmdMotion_DeformLegIk21_FK(t *testing.T) {
	...
	model := loadPmx(t, "../../../internal/test_resources/サンプルモデル_ひざ制限なし.pmx")

	boneDeltas, _ := computeBoneDeltas(model, vmdMotion, motion.Frame(0), []string{"右つま先", pmxNames.HEEL.Right()}, false, false, false)
	{
...
func TestVmdMotion_DeformLegIk22_Bake(t *testing.T) {
	...
	}
	{
		...
		if !boneDeltas.GetByName(pmxNames.KNEE.Right()).FilledGlobalPosition().NearEquals(expectedPosition, 0.03) {
			t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.KNEE.Right()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.KNEE.Right()).FilledGlobalPosition()))
		}
	}
}
...
func TestVmdMotion_DeformLegIk23_Addiction(t *testing.T) {
	...
	boneDeltas, _ := computeBoneDeltas(model, vmdMotion, motion.Frame(0), []string{pmxNames.TOE_IK.Right(), "右つま先"}, true, false, false)
...
func TestVmdMotion_DeformArmIk(t *testing.T) {
	...
	model := loadPmx(t, "../../../internal/test_resources/ボーンツリーテストモデル.pmx")

	boneDeltas, _ := computeBoneDeltas(model, vmdMotion, motion.Frame(3182), nil, true, false, false)
	{
		expectedPosition := vec3(0, 0, 0)
		if !boneDeltas.GetByName(pmxNames.ROOT.String()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
			t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.ROOT.String()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.ROOT.String()).FilledGlobalPosition()))
...
func TestVmdMotion_DeformLegIk25_Ballet(t *testing.T) {
	...
	boneDeltas, _ := computeBoneDeltas(model, vmdMotion, motion.Frame(0), []string{"左つま先", pmxNames.HEEL.Left(), pmxNames.TOE_EX.Left()}, true, false, false)
	...
	{
		expectedPosition := vec3(-3.481956, 11.214747, 1.127255)
		if !boneDeltas.GetByName(pmxNames.LEG_D.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
			t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.LEG_D.Left()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.LEG_D.Left()).FilledGlobalPosition()))
		}
	}
	{
		expectedPosition := vec3(-7.173243, 7.787793, 0.013533)
	...
	{
		expectedPosition := vec3(-11.529483, 3.689184, -1.119154)
		if !boneDeltas.GetByName(pmxNames.ANKLE_D.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
			t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.ANKLE_D.Left()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.ANKLE_D.Left()).FilledGlobalPosition()))
		}
	}
	// {
	// 	expectedPosition := vec3(-12.845280, 2.816309, -2.136874)
	// 	if !boneDeltas.GetByName(pmxNames.TOE_EX.Left()).GetGlobalPosition().NearEquals(expectedPosition, 0.01) {
	// 		t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.TOE_EX.Left()).GetGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.TOE_EX.Left()).GetGlobalPosition()))
	// 	}
	// }
}
...
func TestVmdMotion_DeformLegIk26_Far(t *testing.T) {
	...
	boneDeltas, _ := computeBoneDeltas(model, vmdMotion, motion.Frame(0), []string{"右つま先", pmxNames.TOE_EX.Right(), pmxNames.HEEL.Right()}, true, false, false)
	...
	}
	{
		...
		if !boneDeltas.GetByName(pmxNames.TOE_EX.Right()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
			t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.TOE_EX.Right()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.TOE_EX.Right()).FilledGlobalPosition()))
		}
	}
	{
...
func TestVmdMotion_DeformLegIk27_Addiction_Shoes(t *testing.T) {
	...
	boneDeltas, _ := computeBoneDeltas(model, vmdMotion, motion.Frame(2), nil, true, false, false)
	{
		expectedPosition := vec3(0, 0, 0)
		if !boneDeltas.GetByName(pmxNames.ROOT.String()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
			t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.ROOT.String()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.ROOT.String()).FilledGlobalPosition()))
...
func TestVmdMotion_DeformLegIk28_Gimme_Mitsu(t *testing.T) {
	...
	boneDeltas, _ := computeBoneDeltas(model, vmdMotion, motion.Frame(0), []string{"右つま先", pmxNames.HEEL.Right(), pmxNames.TOE_EX.Right()}, true, false, false)
...
func TestVmdMotion_DeformLegIk28_Gimme_Tda(t *testing.T) {
	...
	toeName := "足首_R_"
	boneDeltas, _ := computeBoneDeltas(model, vmdMotion, motion.Frame(0), []string{"右つま先", pmxNames.HEEL.Right(), pmxNames.TOE_EX.Right(), toeName}, true, false, false)
...
func TestVmdMotion_DeformIk28_Simple(t *testing.T) {
	...
	model := loadPmx(t, "../../../internal/test_resources/IKの挙動を見たい.pmx")
	boneDeltas, _ := computeBoneDeltas(model, vmdMotion, motion.Frame(0), nil, true, false, false)
...
func TestVmdMotion_DeformIk29_Simple(t *testing.T) {
	...
	model := loadPmx(t, "../../../internal/test_resources/IKの挙動を見たい2.pmx")
	boneDeltas, _ := computeBoneDeltas(model, vmdMotion, motion.Frame(0), nil, true, false, false)
	{
		boneName := "A+2"
...
func TestVmdMotion_DeformLegIk25_Addiction_Wa_Right(t *testing.T) {
	...
	model := loadPmx(t, "D:/MMD/MikuMikuDance_v926x64/UserFile/Model/_VMDサイジング/wa_129cm 20231028/wa_129cm_20240406.pmx")
	boneDeltas, _ := computeBoneDeltas(model, vmdMotion, motion.Frame(0), []string{"右襟先"}, true, false, false)
	...
	}
	{
		...
		if !boneDeltas.GetByName(pmxNames.SHOULDER_P.Right()).FilledGlobalPosition().NearEquals(expectedPosition, 0.011) {
			t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.SHOULDER_P.Right()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.SHOULDER_P.Right()).FilledGlobalPosition()))
		}
	}
	{
		expectedPosition := vec3(-0.630131, 13.306683, 2.742505)
		if !boneDeltas.GetByName(pmxNames.SHOULDER.Right()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
			t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.SHOULDER.Right()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.SHOULDER.Right()).FilledGlobalPosition()))
		}
	}
	{
		expectedPosition := vec3(-0.948004, 13.753115, 2.690539)
		if !boneDeltas.GetByName(pmxNames.ARM.Right()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
			t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(pmxNames.ARM.Right()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(pmxNames.ARM.Right()).FilledGlobalPosition()))
		}
	}
	{
...
func TestVmdMotion_DeformIk_Down(t *testing.T) {
	...
	_, _ = computeBoneDeltas(model, vmdMotion, motion.Frame(0), nil, true, false, false)
}
...
func TestVmdMotion_DeformLegIk25_Addiction_Wa_Left(t *testing.T) {
	...
	boneDeltas, _ := computeBoneDeltas(model, vmdMotion, motion.Frame(0), []string{"左襟先"}, true, false, false)
...
func TestVmdMotion_DeformArmIk_Mahoujin_02(t *testing.T) {
	...
	{
		boneName := pmxNames.INDEX3.Right()
...
func TestVmdMotion_AdjustBones(t *testing.T) {
	...
	boneDeltas, _ := computeBoneDeltas(model, vmdMotion, motion.Frame(0), nil, true, false, false)
	{
		boneName := pmxNames.CENTER.String()
	...
	{
		boneName := pmxNames.GROOVE.String()
	...
	{
		boneName := pmxNames.LOWER.String()
...
func TestVmdMotion_Neck(t *testing.T) {
	...
	boneDeltas, _ := computeBoneDeltas(model, vmdMotion, motion.Frame(0), []string{"頭"}, true, false, false)
	{
		boneName := pmxNames.NECK.String()
