...
func TestVmdMotion_Deform_Exists(t *testing.T) {
...

	{
		...
		boneDeltas, _ := computeBoneDeltas(model, motion, motionpkg.Frame(10), []string{pmx.INDEX3.Left()}, false, false, false)
		{
			...
			if !boneDeltas.GetByName(pmx.ROOT.String()).FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmx.CENTER.String()).FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmx.GROOVE.String()).FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmx.WAIST.String()).FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmx.UPPER.String()).FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmx.UPPER2.String()).FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName("上半身3").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmx.SHOULDER_P.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
		...
		{
			expectedPosition := vec3(0.324862, 16.470263, 0.419041)
			if !boneDeltas.GetByName(pmx.SHOULDER.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmx.ARM.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmx.ARM_TWIST.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmx.ELBOW.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmx.WRIST_TWIST.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmx.WRIST.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmx.INDEX1.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmx.INDEX2.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmx.INDEX3.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
...
func TestVmdMotion_DeformLegIk1_Matsu(t *testing.T) {
...

	{
		boneDeltas, _ := computeBoneDeltas(model, motion, motionpkg.Frame(29), []string{"左つま先", pmx.HEEL.Left()}, true, false, false)
		{
			...
			if !boneDeltas.GetByName(pmx.LOWER.String()).FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmx.LEG.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmx.KNEE.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmx.ANKLE.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName("左つま先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmx.HEEL.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
...
func TestVmdMotion_DeformLegIk3_Matsu(t *testing.T) {
...

	{
		...
		{
			expectedPosition := vec3(2.263363, 7.061642, -3.837192)
			if !boneDeltas.GetByName(pmx.KNEE_D.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmx.TOE_EX.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
...
func TestVmdMotion_DeformLegIk4_Snow(t *testing.T) {
	...
	}
	{
		...
		if !boneDeltas.GetByName(pmx.LEG.Right()).FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName(pmx.KNEE.Right()).FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName(pmx.ANKLE.Right()).FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右つま先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName(pmx.HEEL.Right()).FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
...
func TestVmdMotion_DeformLegIk7_Syou_ISAO(t *testing.T) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("腰").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("下半身").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	// 	if !boneDeltas.GetByName("下半身先").GetGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	// }
	{
		...
		if !boneDeltas.GetByName("腰キャンセル左").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左足").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左ひざ").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	{
		expectedPosition := vec3(0.90331914, 10.27362702, 1.00949975)
		if !boneDeltas.GetByName("左足D").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左ひざ2").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左ひざ2先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	{
		expectedPosition := vec3(0.90331914, 10.27362702, 1.00949975)
		if !boneDeltas.GetByName("左足y+").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左足yTgt").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	{
		expectedPosition := vec3(0.74736036, 9.38409308, 0.58008117)
		if !boneDeltas.GetByName("左足yIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左尻").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	{
		expectedPosition := vec3(0.08276818, 5.59348757, -1.24981795)
		if !boneDeltas.GetByName("左ひざsub").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左ひざD2").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左ひざD2先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左足ゆび").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	{
		expectedPosition := vec3(5.63290634e-01, -2.12439821e-04, -3.87768478e-01)
		if !boneDeltas.GetByName("左つま先D").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	// {
	// 	expectedPosition := vec3(0.08276818, 5.59348757, -1.24981795)
	// 	if !boneDeltas.GetByName("左ひざD").GetGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	// {
	// 	expectedPosition := vec3(1.23779916, 1.28891465, 1.65257835)
	// 	if !boneDeltas.GetByName("左足首D").GetGlobalPosition().NearEquals(expectedPosition, 0.02) {
...
func TestVmdMotion_DeformLegIk11_Shining_Miku(t *testing.T) {
	...
	boneDeltas, _ := computeBoneDeltas(model, motion, motionpkg.Frame(0), []string{pmx.LEG_IK.Right(), pmx.HEEL.Right(), "足首_R_"}, true, false, false)
	{
		...
		if !boneDeltas.GetByName(pmx.LEG_IK.Right()).FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("足首_R_").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
...
func TestVmdMotion_DeformLegIk13_Lamb(t *testing.T) {
	...
	}
	{

		{
			...
			if !boneDeltas.GetByName(pmx.LEG_IK.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
...
func TestVmdMotion_DeformLegIk24_Positive(t *testing.T) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左足捩").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左足捩先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	{
		expectedPosition := vec3(-2.455364, 6.571013, -1.935295)
		if !boneDeltas.GetByName("左足向検A").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左足向検A先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	{
		expectedPosition := vec3(-2.695177, 4.324148, -4.574588)
		if !boneDeltas.GetByName("左足捩検B").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左足捩検B先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左膝補").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左膝補先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左足w").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左足w先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左足向-").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左脛骨D先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
...
func TestVmdMotion_DeformArmIk(t *testing.T) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左人指先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
...
func TestVmdMotion_DeformArmIk3(t *testing.T) {
	...
	boneDeltas, _ := computeBoneDeltas(model, motion, motionpkg.Frame(0), nil, true, false, false)
	{
		...
		if !boneDeltas.GetByName("左腕").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左腕捩").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左ひじ").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	{
		expectedPosition := vec3(1.018832, 15.840092, 0.532239)
		if !boneDeltas.GetByName("左腕W").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	{
		expectedPosition := vec3(1.353175, 13.181011, -0.334196)
		if !boneDeltas.GetByName("左腕W先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	{
		expectedPosition := vec3(1.353175, 13.181011, -0.334196)
		if !boneDeltas.GetByName("左腕WIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
...
func TestVmdMotion_DeformLegIk25_Ballet(t *testing.T) {
	...
	{
		expectedPosition := vec3(-3.481956, 11.214747, 1.127255)
		if !boneDeltas.GetByName(pmx.LEG_D.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	{
		expectedPosition := vec3(-11.529483, 3.689184, -1.119154)
		if !boneDeltas.GetByName(pmx.ANKLE_D.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	// 	if !boneDeltas.GetByName(pmx.TOE_EX.Left()).GetGlobalPosition().NearEquals(expectedPosition, 0.02) {
...
func TestVmdMotion_DeformLegIk26_Far(t *testing.T) {
	...
	}
	{
		...
		if !boneDeltas.GetByName(pmx.TOE_EX.Right()).FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
...
func TestVmdMotion_DeformLegIk27_Addiction_Shoes(t *testing.T) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左足Dw").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左足先EX").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左素足先A").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左素足先A先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	{
		expectedPosition := vec3(1.453982, 0.305976, -0.510022)
		if !boneDeltas.GetByName("左素足先AIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左素足先B").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左素足先B先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左素足先BIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左靴調節").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左靴追従").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左靴追従先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	{
		expectedPosition := vec3(1.173929, 2.066327, 0.182685)
		if !boneDeltas.GetByName("左靴追従IK").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左足補D").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左足補D先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	{
		expectedPosition := vec3(0.150401, 5.170907, -0.712416)
		if !boneDeltas.GetByName("左足補DIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	{
		expectedPosition := vec3(-0.327781, 5.203805, -1.073719)
		if !boneDeltas.GetByName("左足向検AIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左膝補IK").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	{
		expectedPosition := vec3(-2.392915, 7.450026, -2.735495)
		if !boneDeltas.GetByName("左足捩検BIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
...
func TestVmdMotion_DeformLegIk28_Gimme_Tda(t *testing.T) {
	...
	}
	{
		...
		if !boneDeltas.GetByName(toeName).FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
...
func TestVmdMotion_DeformIk28_Simple(t *testing.T) {
...

	{
		...
		if !boneDeltas.GetByName("A+tail").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("A+IK").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("B+IK").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("C+tail").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("C+IK").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
...
func TestVmdMotion_DeformIk29_Simple(t *testing.T) {
	...
	boneDeltas, _ := computeBoneDeltas(model, motion, motionpkg.Frame(0), nil, true, false, false)
	{
		...
		if !boneDeltas.GetByName(boneName).FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
...
func TestVmdMotion_DeformArmIk2(t *testing.T) {
	...
	{
		expectedPosition := vec3(0.04952335, 11.9671191, 1.06765032)
		if !boneDeltas.GetByName("上半身").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("上半身2").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右肩").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右肩C").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	{
		expectedPosition := vec3(-0.63104276, 15.44542768, 0.8507726)
		if !boneDeltas.GetByName("右腕").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右腕捩").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右ひじ").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手捩").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手首").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	{
		expectedPosition := vec3(-0.63104276, 15.44542768, 0.8507726)
		if !boneDeltas.GetByName("右腕YZ").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右腕YZ先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右腕YZIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	{
		expectedPosition := vec3(-0.63104276, 15.44542768, 0.8507726)
		if !boneDeltas.GetByName("右腕X").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右腕X先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右腕XIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右腕捩YZ").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右腕捩YZTgt").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右腕捩YZIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	{
		expectedPosition := vec3(-0.90325538, 14.53727326, 0.79258165)
		if !boneDeltas.GetByName("右腕捩X").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右腕捩XTgt").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右腕捩XIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右ひじYZ").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右ひじYZ先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右ひじYZIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	{
		expectedPosition := vec3(-1.50499623, 12.52974836, 0.66394738)
		if !boneDeltas.GetByName("右ひじX").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右ひじXIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	{
		expectedPosition := vec3(-1.50499623, 12.52974836, 0.66394738)
		if !boneDeltas.GetByName("右ひじY").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右ひじY先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	{
		expectedPosition := vec3(-1.48334297, 12.74012453, 0.34654052)
		if !boneDeltas.GetByName("右ひじYIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手捩YZ").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手捩YZTgt").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手捩YZIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	{
		expectedPosition := vec3(-1.46845628, 12.88475892, 0.12832214)
		if !boneDeltas.GetByName("右手捩X").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手捩XTgt").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手捩XIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手YZ先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手YZIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手X").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手X先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手XIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右腕捩1").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右腕捩2").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右腕捩3").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右腕捩4").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右ひじsub").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右ひじsub先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手捩1").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手捩2").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手捩3").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手捩4").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手捩5").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手捩6").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手首R").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	{
		expectedPosition := vec3(-1.36500465, 13.89623575, -1.42501008)
		if !boneDeltas.GetByName("右手首1").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手首2").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
...
func TestVmdMotion_DeformLegIk25_Addiction_Wa_Right(t *testing.T) {
	...
	}
	{
		...
		if !boneDeltas.GetByName(pmx.SHOULDER_P.Right()).FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName(pmx.SHOULDER.Right()).FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName(pmx.ARM.Right()).FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右上半身C-A").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右鎖骨IK").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右鎖骨").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右鎖骨先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右肩Rz検").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右肩Rz検先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	{
		expectedPosition := vec3(-0.235138, 13.300934, 2.666039)
		if !boneDeltas.GetByName("右肩Ry検").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右肩Ry検先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右上半身C-B").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右上半身C-C").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右上半身2").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右襟").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右襟先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
...
func TestVmdMotion_DeformArmIk4_DMF(t *testing.T) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左肩").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手捩").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手首").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左腕YZ").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左腕YZ先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左腕YZIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左腕X").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左腕X先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左腕XIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左腕捩YZ").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左腕捩YZTgt").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左腕捩YZIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左腕捩X").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左腕捩XTgt").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左腕捩XIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左ひじYZ").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左ひじYZ先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左ひじYZIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左ひじX").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左ひじX先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左ひじXIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左ひじY").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	{
		expectedPosition := vec3(9.360781, 13.672805, 1.745905)
		if !boneDeltas.GetByName("左ひじYIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手捩YZ").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手捩YZTgt").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手捩YZIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手捩X").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手捩XTgt").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手捩XIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手YZ先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手YZIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手X").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手X先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手XIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左腕捩1").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左腕捩2").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左腕捩3").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左腕捩4").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左ひじsub").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手捩1").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手捩2").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手捩3").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手捩4").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手捩5").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手捩6").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手首R").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手首1").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手首2").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
...
func TestVmdMotion_DeformLegIk25_Addiction_Wa_Left(t *testing.T) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左上半身C-A").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左鎖骨IK").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左鎖骨").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左鎖骨先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左肩Rz検").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左肩Rz検先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左肩Ry検").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左肩Ry検先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左上半身C-B").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左上半身C-C").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左上半身2").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左襟").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左襟先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
