...
func TestVmdMotion_Deform_Exists(t *testing.T) {
	motion := loadVmd(t, "../../../internal/test_resources/サンプルモーション.vmd")
...

	{
		...
		boneDeltas, _ := computeBoneDeltas(model, motion, motionpkg.Frame(10), []string{pmx.INDEX3.Left()}, false, false, false)
		{
			...
			if !boneDeltas.GetByName(pmx.ROOT.String()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmx.CENTER.String()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmx.GROOVE.String()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmx.WAIST.String()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmx.UPPER.String()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmx.UPPER2.String()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmx.SHOULDER_P.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
		...
		{
			expectedPosition := vec3(0.324862, 16.470263, 0.419041)
			if !boneDeltas.GetByName(pmx.SHOULDER.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmx.ARM.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmx.ARM_TWIST.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmx.ELBOW.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmx.WRIST_TWIST.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmx.WRIST.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmx.INDEX1.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmx.INDEX2.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmx.INDEX3.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
...
func TestVmdMotion_DeformLegIk1_Matsu(t *testing.T) {
...

	{
		boneDeltas, _ := computeBoneDeltas(model, motion, motionpkg.Frame(29), []string{"左つま先", pmx.HEEL.Left()}, true, false, false)
		{
			...
			if !boneDeltas.GetByName(pmx.LOWER.String()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmx.LEG.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmx.KNEE.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmx.ANKLE.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmx.HEEL.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
...
func TestVmdMotion_DeformLegIk3_Matsu(t *testing.T) {
	...
	motion := loadVmd(t, "../../../internal/test_resources/腰元.vmd")
...

	{
		...
		{
			expectedPosition := vec3(2.263363, 7.061642, -3.837192)
			if !boneDeltas.GetByName(pmx.KNEE_D.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmx.TOE_EX.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
...
func TestVmdMotion_DeformLegIk4_Snow(t *testing.T) {
	...
	motion := loadVmd(t, "../../../internal/test_resources/好き雪_2794.vmd")
	...
	}
	{
		...
		if !boneDeltas.GetByName(pmx.LEG.Right()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName(pmx.KNEE.Right()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName(pmx.ANKLE.Right()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName(pmx.HEEL.Right()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
...
func TestVmdMotion_DeformLegIk7_Syou_ISAO(t *testing.T) {
	...
	motion := loadVmd(t, "../../../internal/test_resources/唱（ダンスのみ）_0274F.vmd")
...
func TestVmdMotion_DeformLegIk7_Syou(t *testing.T) {
	...
	motion := loadVmd(t, "../../../internal/test_resources/唱（ダンスのみ）_0278F.vmd")
...
func TestVmdMotion_DeformLegIk8_Syou(t *testing.T) {
	motion := loadVmd(t, "../../../internal/test_resources/唱（ダンスのみ）_0-300F.vmd")
...
func TestVmdMotion_DeformLegIk11_Shining_Miku(t *testing.T) {
	// mlog.SetLevel(mlog.IK_VERBOSE)
	motion := loadVmd(t, "../../../internal/test_resources/シャイニングミラクル_50F.vmd")
	...
	boneDeltas, _ := computeBoneDeltas(model, motion, motionpkg.Frame(0), []string{pmx.LEG_IK.Right(), pmx.HEEL.Right(), "足首_R_"}, true, false, false)
	{
		...
		if !boneDeltas.GetByName(pmx.LEG_IK.Right()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
...
func TestVmdMotion_DeformLegIk12_Down_Miku(t *testing.T) {
	// mlog.SetLevel(mlog.IK_VERBOSE)
	motion := loadVmd(t, "../../../internal/test_resources/しゃがむ.vmd")
...
func TestVmdMotion_DeformLegIk13_Lamb(t *testing.T) {
	motion := loadVmd(t, "../../../internal/test_resources/Lamb_2689F.vmd")
	...
	}
	{

		{
			...
			if !boneDeltas.GetByName(pmx.LEG_IK.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
...
func TestVmdMotion_DeformLegIk14_Ballet(t *testing.T) {
	motion := loadVmd(t, "../../../internal/test_resources/ミク用バレリーコ_1069.vmd")
...
func TestVmdMotion_DeformLegIk15_Bottom(t *testing.T) {
	...
	motion := loadVmd(t, "../../../internal/test_resources/●ボトム_0-300.vmd")
...
func TestVmdMotion_DeformLegIk17_Snow(t *testing.T) {
	...
	motion := loadVmd(t, "../../../internal/test_resources/好き雪_1075.vmd")
...
func TestVmdMotion_DeformLegIk19_Wa(t *testing.T) {
	motion := loadVmd(t, "../../../internal/test_resources/129cm_001_10F.vmd")
...
func TestVmdMotion_DeformLegIk21_FK(t *testing.T) {
	motion := loadVmd(t, "../../../internal/test_resources/足FK.vmd")
...
func TestVmdMotion_DeformLegIk22_Bake(t *testing.T) {
	motion := loadVmd(t, "../../../internal/test_resources/足FK焼き込み.vmd")
...
func TestVmdMotion_DeformLegIk23_Addiction(t *testing.T) {
	motion := loadVmd(t, "../../../internal/test_resources/[A]ddiction_Lat式_0171F.vmd")
...
func TestVmdMotion_DeformLegIk24_Positive(t *testing.T) {
	...
	motion := loadVmd(t, "../../../internal/test_resources/ポジティブパレード_0526.vmd")
...
func TestVmdMotion_DeformArmIk3(t *testing.T) {
	motion := loadVmd(t, "../../../internal/test_resources/Addiction_0F.vmd")
...
func TestVmdMotion_DeformLegIk25_Ballet(t *testing.T) {
	...
	motion := loadVmd(t, "../../../internal/test_resources/青江バレリーコ_1543F.vmd")
	...
	{
		expectedPosition := vec3(-3.481956, 11.214747, 1.127255)
		if !boneDeltas.GetByName(pmx.LEG_D.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	{
		expectedPosition := vec3(-11.529483, 3.689184, -1.119154)
		if !boneDeltas.GetByName(pmx.ANKLE_D.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	// 	if !boneDeltas.GetByName(pmx.TOE_EX.Left()).GetGlobalPosition().NearEquals(expectedPosition, 0.01) {
...
func TestVmdMotion_DeformLegIk26_Far(t *testing.T) {
	...
	motion := loadVmd(t, "../../../internal/test_resources/足IK乖離.vmd")
	...
	}
	{
		...
		if !boneDeltas.GetByName(pmx.TOE_EX.Right()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
...
func TestVmdMotion_DeformLegIk27_Addiction_Shoes(t *testing.T) {
	...
	motion := loadVmd(t, "../../../internal/test_resources/[A]ddiction_和洋_1074-1078F.vmd")
...
func TestVmdMotion_DeformLegIk28_Gimme_Mitsu(t *testing.T) {
	...
	motion := loadVmd(t, "../../../internal/test_resources/ぎみぎみ_498F.vmd")
...
func TestVmdMotion_DeformIk28_Simple(t *testing.T) {
	...
	motion := loadVmd(t, "../../../internal/test_resources/IKの挙動を見たい_020.vmd")
...
func TestVmdMotion_DeformIk29_Simple(t *testing.T) {
	...
	motion := loadVmd(t, "../../../internal/test_resources/IKの挙動を見たい2_040.vmd")
...
func TestVmdMotion_DeformLegIk25_Addiction_Wa_Right(t *testing.T) {
	...
	motion := loadVmd(t, "../../../internal/test_resources/[A]ddiction_和洋_0126F.vmd")
	...
	}
	{
		...
		if !boneDeltas.GetByName(pmx.SHOULDER_P.Right()).FilledGlobalPosition().NearEquals(expectedPosition, 0.011) {
	...
	}
	{
		...
		if !boneDeltas.GetByName(pmx.SHOULDER.Right()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName(pmx.ARM.Right()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
...
func TestVmdMotion_DeformIk_Down(t *testing.T) {
	...
	motion := loadVmd(t, "../../../internal/test_resources/センター下げる.vmd")
...
func TestVmdMotion_DeformArmIk4_DMF(t *testing.T) {
	...
	motion := loadVmd(t, "../../../internal/test_resources/nac_dmf_601.vmd")
...
func TestVmdMotion_DeformArmIk_Mahoujin_02(t *testing.T) {
	...
	motion := loadVmd(t, "../../../internal/test_resources/arm_ik_mahoujin_006F.vmd")
...
func TestVmdMotion_DeformArmIk_Mahoujin_03(t *testing.T) {
	...
	motion := loadVmd(t, "../../../internal/test_resources/arm_ik_mahoujin_060F.vmd")
...
func TestVmdMotion_DeformArmIk_Choco_01(t *testing.T) {
	...
	motion := loadVmd(t, "../../../internal/test_resources/ビタチョコ_0676F.vmd")
...
func TestVmdMotion_AdjustBones(t *testing.T) {
	...
	motion := loadVmd(t, "../../../internal/test_resources/調整用ボーン移動.vmd")
...
func TestVmdMotion_Neck(t *testing.T) {
	...
	motion := loadVmd(t, "../../../internal/test_resources/くるりん_150F.vmd")
