...
func TestVmdMotion_Deform_Exists(t *testing.T) {
	vmdMotion := loadVmd(t, "../../../internal/test_resources/サンプルモーション.vmd")

	pmxModel := loadPmx(t, "../../../internal/test_resources/サンプルモデル.pmx")

	{

		boneDeltas, _ := computeBoneDeltas(pmxModel, vmdMotion, motion.Frame(10), []string{model.INDEX3.Left()}, false, false, false)
		{
			expectedPosition := vec3(0.0, 0.0, 0.0)
			if !boneDeltas.GetByName(model.ROOT.String()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(model.CENTER.String()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(model.CENTER.String()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(model.CENTER.String()).FilledGlobalPosition()))
			}
		}
		{
			expectedPosition := vec3(0.044920, 9.392067, 0.064877)
			if !boneDeltas.GetByName(model.GROOVE.String()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(model.GROOVE.String()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(model.GROOVE.String()).FilledGlobalPosition()))
			}
		}
		{
			expectedPosition := vec3(0.044920, 11.740084, 0.055937)
			if !boneDeltas.GetByName(model.WAIST.String()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(model.WAIST.String()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(model.WAIST.String()).FilledGlobalPosition()))
			}
		}
		{
			expectedPosition := vec3(0.044920, 12.390969, -0.100531)
			if !boneDeltas.GetByName(model.UPPER.String()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(model.UPPER.String()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(model.UPPER.String()).FilledGlobalPosition()))
			}
		}
		{
			expectedPosition := vec3(0.044920, 13.803633, -0.138654)
			if !boneDeltas.GetByName(model.UPPER2.String()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(model.UPPER2.String()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(model.UPPER2.String()).FilledGlobalPosition()))
			}
		}
		{
			expectedPosition := vec3(0.044920, 15.149180, 0.044429)
			if !boneDeltas.GetByName("上半身3").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(model.SHOULDER_P.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(model.SHOULDER_P.Left()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(model.SHOULDER_P.Left()).FilledGlobalPosition()))
			}
		}
		{
			expectedPosition := vec3(0.324862, 16.470263, 0.419041)
			if !boneDeltas.GetByName(model.SHOULDER.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(model.SHOULDER.Left()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(model.SHOULDER.Left()).FilledGlobalPosition()))
			}
		}
		{
			expectedPosition := vec3(1.369838, 16.312170, 0.676838)
			if !boneDeltas.GetByName(model.ARM.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(model.ARM.Left()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(model.ARM.Left()).FilledGlobalPosition()))
			}
		}
		{
			expectedPosition := vec3(1.845001, 15.024807, 0.747681)
			if !boneDeltas.GetByName(model.ARM_TWIST.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(model.ARM_TWIST.Left()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(model.ARM_TWIST.Left()).FilledGlobalPosition()))
			}
		}
		{
			expectedPosition := vec3(2.320162, 13.737446, 0.818525)
			if !boneDeltas.GetByName(model.ELBOW.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(model.ELBOW.Left()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(model.ELBOW.Left()).FilledGlobalPosition()))
			}
		}
		{
			expectedPosition := vec3(2.526190, 12.502445, 0.336127)
			if !boneDeltas.GetByName(model.WRIST_TWIST.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(model.WRIST_TWIST.Left()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(model.WRIST_TWIST.Left()).FilledGlobalPosition()))
			}
		}
		{
			expectedPosition := vec3(2.732219, 11.267447, -0.146273)
			if !boneDeltas.GetByName(model.WRIST.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(model.WRIST.Left()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(model.WRIST.Left()).FilledGlobalPosition()))
			}
		}
		{
			expectedPosition := vec3(2.649188, 10.546797, -0.607412)
			if !boneDeltas.GetByName(model.INDEX1.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(model.INDEX1.Left()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(model.INDEX1.Left()).FilledGlobalPosition()))
			}
		}
		{
			expectedPosition := vec3(2.408238, 10.209290, -0.576288)
			if !boneDeltas.GetByName(model.INDEX2.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(model.INDEX2.Left()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(model.INDEX2.Left()).FilledGlobalPosition()))
			}
		}
		{
			expectedPosition := vec3(2.360455, 10.422402, -0.442668)
			if !boneDeltas.GetByName(model.INDEX3.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(model.INDEX3.Left()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(model.INDEX3.Left()).FilledGlobalPosition()))
			}
		}
	}
}
...
func TestVmdMotion_Deform_Lerp(t *testing.T) {
	...
	{
		boneDeltas, _ := computeBoneDeltas(pmxModel, vmdMotion, motion.Frame(999), []string{model.INDEX3.Left()}, true, false, false)
		{
			expectedPosition := vec3(0.0, 0.0, 0.0)
			if !boneDeltas.GetByName(model.ROOT.String()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(model.ROOT.String()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(model.ROOT.String()).FilledGlobalPosition()))
...
func TestVmdMotion_DeformLegIk1_Matsu(t *testing.T) {
	...
	{
		boneDeltas, _ := computeBoneDeltas(pmxModel, vmdMotion, motion.Frame(29), []string{"左つま先", model.HEEL.Left()}, true, false, false)
		{
			expectedPosition := vec3(-0.781335, 11.717622, 1.557067)
			if !boneDeltas.GetByName(model.LOWER.String()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(model.LEG.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(model.LEG.Left()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(model.LEG.Left()).FilledGlobalPosition()))
			}
		}
		{
			expectedPosition := vec3(0.983212, 6.945313, 0.487476)
			if !boneDeltas.GetByName(model.KNEE.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(model.KNEE.Left()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(model.KNEE.Left()).FilledGlobalPosition()))
			}
		}
		{
			expectedPosition := vec3(-0.345842, 2.211842, 2.182894)
			if !boneDeltas.GetByName(model.ANKLE.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(model.ANKLE.Left()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(model.ANKLE.Left()).FilledGlobalPosition()))
			}
		}
		{
			expectedPosition := vec3(-0.109262, -0.025810, 1.147780)
			if !boneDeltas.GetByName("左つま先").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(model.HEEL.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(model.HEEL.Left()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(model.HEEL.Left()).FilledGlobalPosition()))
			}
		}
	}
}
...
func TestVmdMotion_DeformLegIk2_Matsu(t *testing.T) {
	...
	{
		boneDeltas, _ := computeBoneDeltas(pmxModel, vmdMotion, motion.Frame(3152), []string{"左つま先", model.HEEL.Left()}, true, false, false)
		{
...
func TestVmdMotion_DeformLegIk3_Matsu(t *testing.T) {
	...
	vmdMotion := loadVmd(t, "../../../internal/test_resources/腰元.vmd")

	pmxModel := loadPmx(t, "../../../internal/test_resources/サンプルモデル.pmx")

	{
		boneDeltas, _ := computeBoneDeltas(pmxModel, vmdMotion, motion.Frame(60), nil, true, false, false)
		{
		...
		{
			expectedPosition := vec3(2.263363, 7.061642, -3.837192)
			if !boneDeltas.GetByName(model.KNEE_D.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(model.KNEE_D.Left()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(model.KNEE_D.Left()).FilledGlobalPosition()))
			}
		}
		{
			expectedPosition := vec3(1.916109, 1.177077, -1.452845)
			if !boneDeltas.GetByName(model.TOE_EX.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(model.TOE_EX.Left()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(model.TOE_EX.Left()).FilledGlobalPosition()))
			}
		}
		{
...
func TestVmdMotion_DeformLegIk4_Snow(t *testing.T) {
	...
	vmdMotion := loadVmd(t, "../../../internal/test_resources/好き雪_2794.vmd")

	pmxModel := loadPmx(t, "../../../internal/test_resources/サンプルモデル.pmx")

	boneDeltas, _ := computeBoneDeltas(pmxModel, vmdMotion, motion.Frame(0), []string{"右つま先", model.HEEL.Right()}, true, false, false)
	{
	...
	}
	{
		...
		if !boneDeltas.GetByName(model.LEG.Right()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName(model.KNEE.Right()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName(model.ANKLE.Right()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
			t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(model.ANKLE.Right()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(model.ANKLE.Right()).FilledGlobalPosition()))
		}
	}
	{
		expectedPosition := vec3(-1.701147, 6.066556, 3.384271)
		if !boneDeltas.GetByName("右つま先").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName(model.HEEL.Right()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
			t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(model.HEEL.Right()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(model.HEEL.Right()).FilledGlobalPosition()))
		}
	}
}
...
func TestVmdMotion_DeformLegIk5_Koshi(t *testing.T) {
	...
	boneDeltas, _ := computeBoneDeltas(pmxModel, vmdMotion, motion.Frame(7409), []string{"右つま先", model.HEEL.Right()}, true, false, false)
	{
...
func TestVmdMotion_DeformLegIk6_KoshiOff(t *testing.T) {
	...
	// IK OFF
	boneDeltas, _ := computeBoneDeltas(pmxModel, vmdMotion, motion.Frame(0), nil, false, false, false)
	{
...
func TestVmdMotion_DeformLegIk6_KoshiIkOn(t *testing.T) {
	...
	ikEnabledFrame := motion.NewIkEnabledFrame(motion.Frame(fno), model.LEG_IK.Left())
	ikEnabledFrame.Enabled = true

	ikFrame := motion.NewIkFrame(motion.Frame(fno))
...
func TestVmdMotion_DeformLegIk7_Syou_ISAO(t *testing.T) {
	...
	vmdMotion := loadVmd(t, "../../../internal/test_resources/唱（ダンスのみ）_0274F.vmd")

	pmxModel := loadPmx(t, "D:/MMD/MikuMikuDance_v926x64/UserFile/Model/VOCALOID/初音ミク/ISAO式ミク/I_ミクv4/Miku_V4_準標準.pmx")
	...
	}
	{
		...
		if !boneDeltas.GetByName("腰").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("下半身").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	// }
	{
		...
		if !boneDeltas.GetByName("腰キャンセル左").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左足").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左ひざ").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	{
		expectedPosition := vec3(0.90331914, 10.27362702, 1.00949975)
		if !boneDeltas.GetByName("左足D").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左ひざ2").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	{
		expectedPosition := vec3(0.90331914, 10.27362702, 1.00949975)
		if !boneDeltas.GetByName("左足y+").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左足yTgt").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	{
		expectedPosition := vec3(0.74736036, 9.38409308, 0.58008117)
		if !boneDeltas.GetByName("左足yIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	{
		expectedPosition := vec3(-0.02018836, 10.40081089, 1.26859617)
		if !boneDeltas.GetByName("左尻").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	{
		expectedPosition := vec3(0.08276818, 5.59348757, -1.24981795)
		if !boneDeltas.GetByName("左ひざsub").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左ひざsub先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左ひざD2").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左ひざD2先").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	{
		expectedPosition := vec3(0.12060311, 4.95396153, -1.23761938)
		if !boneDeltas.GetByName("左ひざD2IK").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左足ゆび").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	{
		expectedPosition := vec3(5.63290634e-01, -2.12439821e-04, -3.87768478e-01)
		if !boneDeltas.GetByName("左つま先D").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	// {
	// 	expectedPosition := vec3(0.08276818, 5.59348757, -1.24981795)
	// 	if !boneDeltas.GetByName("左ひざD").GetGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	// {
	// 	expectedPosition := vec3(1.23779916, 1.28891465, 1.65257835)
	// 	if !boneDeltas.GetByName("左足首D").GetGlobalPosition().NearEquals(expectedPosition, 0.01) {
...
func TestVmdMotion_DeformLegIk7_Syou(t *testing.T) {
	...
	vmdMotion := loadVmd(t, "../../../internal/test_resources/唱（ダンスのみ）_0278F.vmd")
...
func TestVmdMotion_DeformLegIk8_Syou(t *testing.T) {
	vmdMotion := loadVmd(t, "../../../internal/test_resources/唱（ダンスのみ）_0-300F.vmd")

	pmxModel := loadPmx(t, "../../../internal/test_resources/サンプルモデル.pmx")

	boneDeltas, _ := computeBoneDeltas(pmxModel, vmdMotion, motion.Frame(278), []string{"右つま先", model.HEEL.Right()}, true, false, false)
	{
		expectedPosition := vec3(0.721499, 11.767294, 1.638818)
		if !boneDeltas.GetByName(model.LOWER.String()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
			t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(model.LOWER.String()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(model.LOWER.String()).FilledGlobalPosition()))
...
func TestVmdMotion_DeformLegIk10_Syou1(t *testing.T) {
	...
	boneDeltas, _ := computeBoneDeltas(pmxModel, vmdMotion, motion.Frame(100), []string{"右つま先", model.HEEL.Right()}, true, false, false)
	{
...
func TestVmdMotion_DeformLegIk10_Syou2(t *testing.T) {
	...
	boneDeltas, _ := computeBoneDeltas(pmxModel, vmdMotion, motion.Frame(107), []string{"右つま先", model.HEEL.Right()}, true, false, false)
	{
...
func TestVmdMotion_DeformLegIk10_Syou3(t *testing.T) {
	...
	boneDeltas, _ := computeBoneDeltas(pmxModel, vmdMotion, motion.Frame(272), []string{"右つま先", model.HEEL.Right()}, true, false, false)
	{
...
func TestVmdMotion_DeformLegIk10_Syou4(t *testing.T) {
	...
	boneDeltas, _ := computeBoneDeltas(pmxModel, vmdMotion, motion.Frame(273), []string{"右つま先", model.HEEL.Right()}, true, false, false)
	{
...
func TestVmdMotion_DeformLegIk10_Syou5(t *testing.T) {
	...
	boneDeltas, _ := computeBoneDeltas(pmxModel, vmdMotion, motion.Frame(274), []string{"右つま先", model.HEEL.Right()}, true, false, false)
	{
...
func TestVmdMotion_DeformLegIk11_Shining_Miku(t *testing.T) {
	// mlog.SetLevel(mlog.IK_VERBOSE)
	vmdMotion := loadVmd(t, "../../../internal/test_resources/シャイニングミラクル_50F.vmd")

	pmxModel := loadPmx(t, "D:/MMD/MikuMikuDance_v926x64/UserFile/Model/VOCALOID/初音ミク/Tda式初音ミク_盗賊つばき流Ｍトレースモデル配布 v1.07/Tda式初音ミク_盗賊つばき流Mトレースモデルv1.07_かかと.pmx")

	boneDeltas, _ := computeBoneDeltas(pmxModel, vmdMotion, motion.Frame(0), []string{model.LEG_IK.Right(), model.HEEL.Right(), "足首_R_"}, true, false, false)
	{
		expectedPosition := vec3(-1.869911, 2.074591, -0.911531)
		if !boneDeltas.GetByName(model.LEG_IK.Right()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("足首_R_").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
...
func TestVmdMotion_DeformLegIk12_Down_Miku(t *testing.T) {
	// mlog.SetLevel(mlog.IK_VERBOSE)
	vmdMotion := loadVmd(t, "../../../internal/test_resources/しゃがむ.vmd")
...
func TestVmdMotion_DeformLegIk13_Lamb(t *testing.T) {
	vmdMotion := loadVmd(t, "../../../internal/test_resources/Lamb_2689F.vmd")

	pmxModel := loadPmx(t, "D:/MMD/MikuMikuDance_v926x64/UserFile/Model/ゲーム/戦国BASARA/幸村 たぬき式 ver.1.24/真田幸村没第二衣装1.24軽量版.pmx")
	boneDeltas, _ := computeBoneDeltas(pmxModel, vmdMotion, motion.Frame(0), []string{model.LEG_IK.Right(), "右つま先", model.LEG_IK.Left(), "左つま先", model.HEEL.Left()}, true, false, false)
	...
	}
	{

		{
			...
			if !boneDeltas.GetByName(model.LEG_IK.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(model.LEG_IK.Left()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(model.LEG_IK.Left()).FilledGlobalPosition()))
			}
		}
		{
			expectedPosition := vec3(0.803149, 6.056844, -10.232766)
...
func TestVmdMotion_DeformLegIk14_Ballet(t *testing.T) {
	vmdMotion := loadVmd(t, "../../../internal/test_resources/ミク用バレリーコ_1069.vmd")

	pmxModel := loadPmx(t, "D:/MMD/MikuMikuDance_v926x64/UserFile/Model/_あにまさ式/初音ミク_準標準.pmx")

	boneDeltas, _ := computeBoneDeltas(pmxModel, vmdMotion, motion.Frame(0), []string{model.LEG_IK.Right(), "右つま先", model.HEEL.Right()}, true, false, false)
	{
...
func TestVmdMotion_DeformLegIk15_Bottom(t *testing.T) {
	...
	vmdMotion := loadVmd(t, "../../../internal/test_resources/●ボトム_0-300.vmd")

	pmxModel := loadPmx(t, "D:/MMD/MikuMikuDance_v926x64/UserFile/Model/VOCALOID/初音ミク/Tda式初音ミク_盗賊つばき流Ｍトレースモデル配布 v1.07/Tda式初音ミク_盗賊つばき流Mトレースモデルv1.07_かかと.pmx")

	boneDeltas, _ := computeBoneDeltas(pmxModel, vmdMotion, motion.Frame(218), []string{model.LEG_IK.Right(), model.HEEL.Right(), "足首_R_"}, true, false, false)
	{
...
func TestVmdMotion_DeformLegIk17_Snow(t *testing.T) {
	...
	vmdMotion := loadVmd(t, "../../../internal/test_resources/好き雪_1075.vmd")

	pmxModel := loadPmx(t, "D:/MMD/MikuMikuDance_v926x64/UserFile/Model/VOCALOID/初音ミク/Lat式ミクVer2.31/Lat式ミクVer2.31_White_準標準.pmx")
...
func TestVmdMotion_DeformLegIk19_Wa(t *testing.T) {
	vmdMotion := loadVmd(t, "../../../internal/test_resources/129cm_001_10F.vmd")

	pmxModel := loadPmx(t, "D:/MMD/MikuMikuDance_v926x64/UserFile/Model/_VMDサイジング/wa_129cm 20231028/wa_129cm_bone-structure.pmx")
...
func TestVmdMotion_DeformLegIk21_FK(t *testing.T) {
	vmdMotion := loadVmd(t, "../../../internal/test_resources/足FK.vmd")

	pmxModel := loadPmx(t, "../../../internal/test_resources/サンプルモデル_ひざ制限なし.pmx")

	boneDeltas, _ := computeBoneDeltas(pmxModel, vmdMotion, motion.Frame(0), []string{"右つま先", model.HEEL.Right()}, false, false, false)
	{
...
func TestVmdMotion_DeformLegIk22_Bake(t *testing.T) {
	vmdMotion := loadVmd(t, "../../../internal/test_resources/足FK焼き込み.vmd")
	...
	}
	{
		...
		if !boneDeltas.GetByName(model.KNEE.Right()).FilledGlobalPosition().NearEquals(expectedPosition, 0.03) {
			t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(model.KNEE.Right()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(model.KNEE.Right()).FilledGlobalPosition()))
		}
	}
}
...
func TestVmdMotion_DeformLegIk23_Addiction(t *testing.T) {
	vmdMotion := loadVmd(t, "../../../internal/test_resources/[A]ddiction_Lat式_0171F.vmd")

	pmxModel := loadPmx(t, "D:/MMD/MikuMikuDance_v926x64/UserFile/Model/VOCALOID/初音ミク/Tda式ミクワンピース/Tda式ミクワンピースRSP.pmx")

	boneDeltas, _ := computeBoneDeltas(pmxModel, vmdMotion, motion.Frame(0), []string{model.TOE_IK.Right(), "右つま先"}, true, false, false)
...
func TestVmdMotion_DeformLegIk24_Positive(t *testing.T) {
	...
	vmdMotion := loadVmd(t, "../../../internal/test_resources/ポジティブパレード_0526.vmd")
	...
	}
	{
		...
		if !boneDeltas.GetByName("左脛骨").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左足捩").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左足捩先").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	{
		expectedPosition := vec3(-2.455364, 6.571013, -1.935295)
		if !boneDeltas.GetByName("左足向検A").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左足向検A先").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	{
		expectedPosition := vec3(-2.695177, 4.324148, -4.574588)
		if !boneDeltas.GetByName("左足捩検B").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左足捩検B先").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左膝補").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左膝補先").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左足w").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左足w先").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左足向-").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	{
		expectedPosition := vec3(-3.322137, 6.302598, -1.131305)
		if !boneDeltas.GetByName("左脛骨D").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左脛骨D先").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
...
func TestVmdMotion_DeformArmIk(t *testing.T) {
	...
	pmxModel := loadPmx(t, "../../../internal/test_resources/ボーンツリーテストモデル.pmx")

	boneDeltas, _ := computeBoneDeltas(pmxModel, vmdMotion, motion.Frame(3182), nil, true, false, false)
	{
		expectedPosition := vec3(0, 0, 0)
		if !boneDeltas.GetByName(model.ROOT.String()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
			t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(model.ROOT.String()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(model.ROOT.String()).FilledGlobalPosition()))
	...
	}
	{
		...
		if !boneDeltas.GetByName("左人指先").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
...
func TestVmdMotion_DeformArmIk3(t *testing.T) {
	vmdMotion := loadVmd(t, "../../../internal/test_resources/Addiction_0F.vmd")

	pmxModel := loadPmx(t, "D:/MMD/MikuMikuDance_v926x64/UserFile/Model/VOCALOID/初音ミク/Sour式初音ミクVer.1.02/Black_全表示.pmx")

	boneDeltas, _ := computeBoneDeltas(pmxModel, vmdMotion, motion.Frame(0), nil, true, false, false)
	{
		expectedPosition := vec3(1.018832, 15.840092, 0.532239)
		if !boneDeltas.GetByName("左腕").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左腕捩").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左ひじ").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	{
		expectedPosition := vec3(1.018832, 15.840092, 0.532239)
		if !boneDeltas.GetByName("左腕W").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	{
		expectedPosition := vec3(1.353175, 13.181011, -0.334196)
		if !boneDeltas.GetByName("左腕W先").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	{
		expectedPosition := vec3(1.353175, 13.181011, -0.334196)
		if !boneDeltas.GetByName("左腕WIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
...
func TestVmdMotion_DeformLegIk25_Ballet(t *testing.T) {
	...
	vmdMotion := loadVmd(t, "../../../internal/test_resources/青江バレリーコ_1543F.vmd")

	pmxModel := loadPmx(t, "D:/MMD/MikuMikuDance_v926x64/UserFile/Model/刀剣乱舞/019_にっかり青江/にっかり青江 帽子屋式 ver2.1/帽子屋式にっかり青江（戦装束）_表示枠.pmx")

	boneDeltas, _ := computeBoneDeltas(pmxModel, vmdMotion, motion.Frame(0), []string{"左つま先", model.HEEL.Left(), model.TOE_EX.Left()}, true, false, false)
	...
	{
		expectedPosition := vec3(-3.481956, 11.214747, 1.127255)
		if !boneDeltas.GetByName(model.LEG_D.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
			t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(model.LEG_D.Left()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(model.LEG_D.Left()).FilledGlobalPosition()))
		}
	}
	{
		expectedPosition := vec3(-7.173243, 7.787793, 0.013533)
	...
	{
		expectedPosition := vec3(-11.529483, 3.689184, -1.119154)
		if !boneDeltas.GetByName(model.ANKLE_D.Left()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
			t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(model.ANKLE_D.Left()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(model.ANKLE_D.Left()).FilledGlobalPosition()))
		}
	}
	// {
	// 	expectedPosition := vec3(-12.845280, 2.816309, -2.136874)
	// 	if !boneDeltas.GetByName(model.TOE_EX.Left()).GetGlobalPosition().NearEquals(expectedPosition, 0.01) {
	// 		t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(model.TOE_EX.Left()).GetGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(model.TOE_EX.Left()).GetGlobalPosition()))
	// 	}
	// }
}
...
func TestVmdMotion_DeformLegIk26_Far(t *testing.T) {
	...
	vmdMotion := loadVmd(t, "../../../internal/test_resources/足IK乖離.vmd")

	pmxModel := loadPmx(t, "D:/MMD/MikuMikuDance_v926x64/UserFile/Model/_あにまさ式ミク準標準見せパン/初音ミクVer2 準標準 見せパン 3.pmx")
	boneDeltas, _ := computeBoneDeltas(pmxModel, vmdMotion, motion.Frame(0), []string{"右つま先", model.TOE_EX.Right(), model.HEEL.Right()}, true, false, false)
	...
	}
	{
		...
		if !boneDeltas.GetByName(model.TOE_EX.Right()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
			t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(model.TOE_EX.Right()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(model.TOE_EX.Right()).FilledGlobalPosition()))
		}
	}
	{
...
func TestVmdMotion_DeformLegIk27_Addiction_Shoes(t *testing.T) {
	...
	vmdMotion := loadVmd(t, "../../../internal/test_resources/[A]ddiction_和洋_1074-1078F.vmd")

	pmxModel := loadPmx(t, "D:/MMD/MikuMikuDance_v926x64/UserFile/Model/_VMDサイジング/wa_129cm 20231028/wa_129cm_20240406.pmx")

	boneDeltas, _ := computeBoneDeltas(pmxModel, vmdMotion, motion.Frame(2), nil, true, false, false)
	{
		expectedPosition := vec3(0, 0, 0)
		if !boneDeltas.GetByName(model.ROOT.String()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
			t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(model.ROOT.String()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(model.ROOT.String()).FilledGlobalPosition()))
	...
	}
	{
		...
		if !boneDeltas.GetByName("左脛骨").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
			t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName("左脛骨").FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName("左脛骨").FilledGlobalPosition()))
		}
	}
	{
		expectedPosition := vec3(1.407848, 1.839228, 0.278700)
		if !boneDeltas.GetByName("左脛骨D").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
			t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName("左脛骨D").FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName("左脛骨D").FilledGlobalPosition()))
		}
	}
	{
	...
	}
	{
		...
		if !boneDeltas.GetByName("左足Dw").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左足先EX").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	{
		expectedPosition := vec3(1.551940, 1.045847, 0.024003)
		if !boneDeltas.GetByName("左素足先A").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左素足先A先").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	{
		expectedPosition := vec3(1.453982, 0.305976, -0.510022)
		if !boneDeltas.GetByName("左素足先AIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左素足先B").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左素足先B先").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左素足先BIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左靴調節").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左靴追従").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左靴追従先").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	{
		expectedPosition := vec3(1.173929, 2.066327, 0.182685)
		if !boneDeltas.GetByName("左靴追従IK").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左足補D").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左足補D先").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	{
		expectedPosition := vec3(0.150401, 5.170907, -0.712416)
		if !boneDeltas.GetByName("左足補DIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	{
		expectedPosition := vec3(-0.327781, 5.203805, -1.073719)
		if !boneDeltas.GetByName("左足向検AIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左膝補IK").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	{
		expectedPosition := vec3(-2.392915, 7.450026, -2.735495)
		if !boneDeltas.GetByName("左足捩検BIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
...
func TestVmdMotion_DeformLegIk28_Gimme_Mitsu(t *testing.T) {
	...
	vmdMotion := loadVmd(t, "../../../internal/test_resources/ぎみぎみ_498F.vmd")

	pmxModel := loadPmx(t, "D:/MMD/MikuMikuDance_v926x64/UserFile/Model/オリジナル/折岸みつ つみだんご/折岸みつ.pmx")

	boneDeltas, _ := computeBoneDeltas(pmxModel, vmdMotion, motion.Frame(0), []string{"右つま先", model.HEEL.Right(), model.TOE_EX.Right()}, true, false, false)
...
func TestVmdMotion_DeformLegIk28_Gimme_Mitsu_loop3(t *testing.T) {
	...
	pmxModel := loadPmx(t, "D:/MMD/MikuMikuDance_v926x64/UserFile/Model/オリジナル/折岸みつ つみだんご/折岸みつ_つま先IKループ3.pmx")
...
func TestVmdMotion_DeformLegIk28_Gimme_Mitsu_toe_order(t *testing.T) {
	...
	pmxModel := loadPmx(t, "D:/MMD/MikuMikuDance_v926x64/UserFile/Model/オリジナル/折岸みつ つみだんご/折岸みつ_つま先計算順前.pmx")
...
func TestVmdMotion_DeformLegIk28_Gimme_Miku(t *testing.T) {
	...
	{
		expectedPosition := vec3(0.029125, -0.000434, -1.610423)
		if !boneDeltas.GetByName("右つま先").FilledGlobalPosition().NearEquals(expectedPosition, 0.011) {
			t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName("右つま先").FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName("右つま先").FilledGlobalPosition()))
		}
	}
	{
...
func TestVmdMotion_DeformLegIk28_Gimme_Miku_toe_order(t *testing.T) {
	...
	pmxModel := loadPmx(t, "D:/MMD/MikuMikuDance_v926x64/UserFile/Model/_あにまさ式ミク準標準見せパン/初音ミクVer2 準標準 見せパン 3_つま先計算順後.pmx")
	...
	{
		expectedPosition := vec3(0.029126, -0.000434, -1.610423)
		if !boneDeltas.GetByName("右つま先").FilledGlobalPosition().NearEquals(expectedPosition, 0.011) {
			t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName("右つま先").FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName("右つま先").FilledGlobalPosition()))
		}
	}
...
func TestVmdMotion_DeformLegIk28_Gimme_Tda(t *testing.T) {
	...
	toeName := "足首_R_"
	boneDeltas, _ := computeBoneDeltas(pmxModel, vmdMotion, motion.Frame(0), []string{"右つま先", model.HEEL.Right(), model.TOE_EX.Right(), toeName}, true, false, false)
	...
	}
	{
		...
		if !boneDeltas.GetByName(toeName).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
...
func TestVmdMotion_DeformLegIk28_Gimme_Rin(t *testing.T) {
	...
	pmxModel := loadPmx(t, "D:/MMD/MikuMikuDance_v926x64/UserFile/Model/VOCALOID/鏡音リン/つみ式鏡音リン/つみ式鏡音リン.pmx")
...
func TestVmdMotion_DeformIk28_Simple(t *testing.T) {
	...
	vmdMotion := loadVmd(t, "../../../internal/test_resources/IKの挙動を見たい_020.vmd")

	pmxModel := loadPmx(t, "../../../internal/test_resources/IKの挙動を見たい.pmx")
	boneDeltas, _ := computeBoneDeltas(pmxModel, vmdMotion, motion.Frame(0), nil, true, false, false)

	{
		expectedPosition := vec3(-9.433129, 1.363848, 1.867427)
		if !boneDeltas.GetByName("A+tail").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("A+IK").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("B+IK").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("C+tail").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("C+IK").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
...
func TestVmdMotion_DeformIk29_Simple(t *testing.T) {
	...
	vmdMotion := loadVmd(t, "../../../internal/test_resources/IKの挙動を見たい2_040.vmd")

	pmxModel := loadPmx(t, "../../../internal/test_resources/IKの挙動を見たい2.pmx")
	boneDeltas, _ := computeBoneDeltas(pmxModel, vmdMotion, motion.Frame(0), nil, true, false, false)
	{
		boneName := "A+2"
		expectedPosition := vec3(-5.440584, 2.324726, 0.816799)
		if !boneDeltas.GetByName(boneName).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
...
func TestVmdMotion_DeformArmIk2(t *testing.T) {
	...
	{
		expectedPosition := vec3(0.04952335, 11.9671191, 1.06765032)
		if !boneDeltas.GetByName("上半身").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("上半身2").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右肩").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右肩C").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	{
		expectedPosition := vec3(-0.63104276, 15.44542768, 0.8507726)
		if !boneDeltas.GetByName("右腕").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右腕捩").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右ひじ").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手捩").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手首").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手先").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	{
		expectedPosition := vec3(-0.63104276, 15.44542768, 0.8507726)
		if !boneDeltas.GetByName("右腕YZ").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右腕YZ先").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右腕YZIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	{
		expectedPosition := vec3(-0.63104276, 15.44542768, 0.8507726)
		if !boneDeltas.GetByName("右腕X").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右腕X先").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右腕XIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右腕捩YZ").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右腕捩YZTgt").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右腕捩YZIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	{
		expectedPosition := vec3(-0.90325538, 14.53727326, 0.79258165)
		if !boneDeltas.GetByName("右腕捩X").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右腕捩XTgt").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右腕捩XIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右ひじYZ").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右ひじYZ先").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右ひじYZIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	{
		expectedPosition := vec3(-1.50499623, 12.52974836, 0.66394738)
		if !boneDeltas.GetByName("右ひじX").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右ひじX先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右ひじXIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	{
		expectedPosition := vec3(-1.50499623, 12.52974836, 0.66394738)
		if !boneDeltas.GetByName("右ひじY").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右ひじY先").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	{
		expectedPosition := vec3(-1.48334297, 12.74012453, 0.34654052)
		if !boneDeltas.GetByName("右ひじYIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手捩YZ").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手捩YZTgt").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手捩YZIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	{
		expectedPosition := vec3(-1.46845628, 12.88475892, 0.12832214)
		if !boneDeltas.GetByName("右手捩X").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手捩XTgt").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手捩XIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手YZ先").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手YZIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手X").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手X先").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手XIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右腕捩1").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右腕捩2").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右腕捩3").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右腕捩4").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右ひじsub").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右ひじsub先").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手捩1").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手捩2").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手捩3").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手捩4").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手捩5").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手捩6").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手首R").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	{
		expectedPosition := vec3(-1.36500465, 13.89623575, -1.42501008)
		if !boneDeltas.GetByName("右手首1").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右手首2").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
...
func TestVmdMotion_DeformLegIk25_Addiction_Wa_Right(t *testing.T) {
	...
	vmdMotion := loadVmd(t, "../../../internal/test_resources/[A]ddiction_和洋_0126F.vmd")

	pmxModel := loadPmx(t, "D:/MMD/MikuMikuDance_v926x64/UserFile/Model/_VMDサイジング/wa_129cm 20231028/wa_129cm_20240406.pmx")
	boneDeltas, _ := computeBoneDeltas(pmxModel, vmdMotion, motion.Frame(0), []string{"右襟先"}, true, false, false)
	...
	}
	{
		...
		if !boneDeltas.GetByName(model.SHOULDER_P.Right()).FilledGlobalPosition().NearEquals(expectedPosition, 0.011) {
			t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(model.SHOULDER_P.Right()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(model.SHOULDER_P.Right()).FilledGlobalPosition()))
		}
	}
	{
		expectedPosition := vec3(-0.630131, 13.306683, 2.742505)
		if !boneDeltas.GetByName(model.SHOULDER.Right()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
			t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(model.SHOULDER.Right()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(model.SHOULDER.Right()).FilledGlobalPosition()))
		}
	}
	{
		expectedPosition := vec3(-0.948004, 13.753115, 2.690539)
		if !boneDeltas.GetByName(model.ARM.Right()).FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
			t.Errorf("Expected %v, got %v (%.3f)", expectedPosition, boneDeltas.GetByName(model.ARM.Right()).FilledGlobalPosition(), expectedPosition.Distance(boneDeltas.GetByName(model.ARM.Right()).FilledGlobalPosition()))
		}
	}
	{
		expectedPosition := vec3(-0.611438, 12.394744, 2.353463)
		if !boneDeltas.GetByName("右上半身C-A").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右鎖骨IK").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右鎖骨").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右鎖骨先").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右肩Rz検").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右肩Rz検先").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	{
		expectedPosition := vec3(-0.235138, 13.300934, 2.666039)
		if !boneDeltas.GetByName("右肩Ry検").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右肩Ry検先").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右上半身C-B").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右上半身C-C").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右上半身2").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右襟").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("右襟先").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
...
func TestVmdMotion_DeformIk_Down(t *testing.T) {
	...
	vmdMotion := loadVmd(t, "../../../internal/test_resources/センター下げる.vmd")

	pmxModel := loadPmx(t, "D:/MMD/MikuMikuDance_v926x64/UserFile/Model/_あにまさ式/MEIKO準標準_400.pmx")
...
func TestVmdMotion_DeformArmIk4_DMF(t *testing.T) {
	...
	vmdMotion := loadVmd(t, "../../../internal/test_resources/nac_dmf_601.vmd")

	pmxModel := loadPmx(t, "D:/MMD/MikuMikuDance_v926x64/UserFile/Model/VOCALOID/初音ミク/ISAO式ミク/I_ミクv4/Miku_V4.pmx")
	...
	}
	{
		...
		if !boneDeltas.GetByName("左肩").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手捩").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手首").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手先").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左腕YZ").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左腕YZ先").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左腕YZIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左腕X").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左腕X先").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左腕XIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左腕捩YZ").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左腕捩YZTgt").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左腕捩YZIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左腕捩X").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左腕捩XTgt").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左腕捩XIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左ひじYZ").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左ひじYZ先").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左ひじYZIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左ひじX").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左ひじX先").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左ひじXIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左ひじY").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	{
		expectedPosition := vec3(9.360781, 13.672805, 1.745905)
		if !boneDeltas.GetByName("左ひじYIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手捩YZ").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手捩YZTgt").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手捩YZIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手捩X").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手捩XTgt").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手捩XIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手YZ先").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手YZIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手X").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手X先").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手XIK").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左腕捩1").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左腕捩2").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左腕捩3").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左腕捩4").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左ひじsub").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左ひじsub先").FilledGlobalPosition().NearEquals(expectedPosition, 0.02) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手捩1").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手捩2").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手捩3").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手捩4").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手捩5").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手捩6").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手首R").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手首1").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左手首2").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
...
func TestVmdMotion_DeformLegIk25_Addiction_Wa_Left(t *testing.T) {
	...
	boneDeltas, _ := computeBoneDeltas(pmxModel, vmdMotion, motion.Frame(0), []string{"左襟先"}, true, false, false)
	...
	}
	{
		...
		if !boneDeltas.GetByName("左上半身C-A").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左鎖骨IK").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左鎖骨").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左鎖骨先").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左肩Rz検").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左肩Rz検先").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左肩Ry検").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左上半身C-B").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左上半身C-C").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左上半身2").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左襟").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
	...
	}
	{
		...
		if !boneDeltas.GetByName("左襟先").FilledGlobalPosition().NearEquals(expectedPosition, 0.01) {
...
func TestVmdMotion_DeformArmIk_Mahoujin_02(t *testing.T) {
	...
	vmdMotion := loadVmd(t, "../../../internal/test_resources/arm_ik_mahoujin_006F.vmd")
...
func TestVmdMotion_DeformArmIk_Mahoujin_03(t *testing.T) {
	...
	vmdMotion := loadVmd(t, "../../../internal/test_resources/arm_ik_mahoujin_060F.vmd")
...
func TestVmdMotion_DeformArmIk_Choco_01(t *testing.T) {
	...
	vmdMotion := loadVmd(t, "../../../internal/test_resources/ビタチョコ_0676F.vmd")

	pmxModel := loadPmx(t, "D:/MMD/MikuMikuDance_v926x64/UserFile/Model/ゲーム/Fate/眞白式ロマニ・アーキマン ver.1.01/眞白式ロマニ・アーキマン_ビタチョコ.pmx")
...
func TestVmdMotion_AdjustBones(t *testing.T) {
	...
	vmdMotion := loadVmd(t, "../../../internal/test_resources/調整用ボーン移動.vmd")

	pmxModel := loadPmx(t, "D:/MMD/MikuMikuDance_v926x64/UserFile/Model/_あにまさ式ミク準標準見せパン/初音ミクVer2 準標準 見せパン 3_調整用ボーン追加.pmx")

	boneDeltas, _ := computeBoneDeltas(pmxModel, vmdMotion, motion.Frame(0), nil, true, false, false)
	{
		boneName := model.CENTER.String()
...
func TestVmdMotion_Neck(t *testing.T) {
	...
	vmdMotion := loadVmd(t, "../../../internal/test_resources/くるりん_150F.vmd")

	pmxModel := loadPmx(t, "D:/MMD/MikuMikuDance_v926x64/UserFile/Model/VOCALOID/初音ミク/ISAO式ミク/I_ミクv4/Miku_V4.pmx")

	boneDeltas, _ := computeBoneDeltas(pmxModel, vmdMotion, motion.Frame(0), []string{"頭"}, true, false, false)
	{
		boneName := model.NECK.String()
...
func loadVmd(t *testing.T, path string) *motion.VmdMotion {
	t.Helper()
