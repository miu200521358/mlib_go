swig -c++ -go -cgo -I"C:\Codex\mlib\mlib_go_t4\pkg\infra\drivers\mbullet\bt" ^
    ...
    -cpperraswarn -o "C:\Codex\mlib\mlib_go_t4\pkg\infra\drivers\mbullet\bt\bt.cxx" "C:\Codex\mlib\mlib_go_t4\pkg\infra\drivers\mbullet\bt\bullet.i"
go clean --cache
