...
func TestVmdMotion_DeformLegIk25_Addiction_Wa_Left(t *testing.T) {
...

	{
		...
		}
		{
			...
			if !boneDeltas.GetByName("左上半身C-A").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName("左鎖骨IK").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName("左鎖骨").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName("左肩Rz検").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName("左肩Rz検先").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName("左肩Ry検").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName("左肩Ry検先").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName("左上半身C-B").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName("左上半身C-C").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName("左上半身2").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName("左襟").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
...
func TestVmdMotion_DeformLegIk25_Addiction_Wa_Right(t *testing.T) {
...

	{
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmx.SHOULDER.Right()).GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName(pmx.ARM.Right()).GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName("右上半身C-A").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName("右鎖骨IK").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName("右鎖骨").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName("右鎖骨先").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName("右肩Rz検").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName("右肩Rz検先").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
				t.Errorf("Expected %v, got %v", expectedPosition, boneDeltas.GetByName("右肩Rz検先").GlobalPosition().MMD())
			}
		}
		{
			expectedPosition := &mmath.MVec3{-0.235138, 13.300934, 2.666039}
			if !boneDeltas.GetByName("右肩Ry検").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName("右肩Ry検先").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName("右上半身C-C").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName("右上半身2").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName("右襟").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName("右襟先").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
...
func TestVmdMotion_DeformLegIk27_Addiction_Shoes(t *testing.T) {
...

	{
		...
		}
		{
			...
			if !boneDeltas.GetByName("左足先EX").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName("左素足先A").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName("左素足先A先").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
				t.Errorf("Expected %v, got %v", expectedPosition, boneDeltas.GetByName("左素足先A先").GlobalPosition().MMD())
			}
		}
		{
			expectedPosition := &mmath.MVec3{1.453982, 0.305976, -0.510022}
			if !boneDeltas.GetByName("左素足先AIK").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName("左素足先B").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName("左素足先B先").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName("左素足先BIK").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName("左靴調節").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName("左靴追従").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
		...
		{
			expectedPosition := &mmath.MVec3{1.173929, 2.066327, 0.182685}
			if !boneDeltas.GetByName("左靴追従IK").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName("左足補D").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName("左足補D先").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
				t.Errorf("Expected %v, got %v", expectedPosition, boneDeltas.GetByName("左足補D先").GlobalPosition().MMD())
			}
		}
		{
			expectedPosition := &mmath.MVec3{0.150401, 5.170907, -0.712416}
			if !boneDeltas.GetByName("左足補DIK").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
		...
		{
			expectedPosition := &mmath.MVec3{-0.327781, 5.203805, -1.073719}
			if !boneDeltas.GetByName("左足向検AIK").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
		...
		}
		{
			...
			if !boneDeltas.GetByName("左膝補IK").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
		...
		{
			expectedPosition := &mmath.MVec3{-2.392915, 7.450026, -2.735495}
			if !boneDeltas.GetByName("左足捩検BIK").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.02) {
