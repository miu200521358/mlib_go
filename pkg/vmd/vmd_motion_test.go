...
func TestVmdMotion_AnimateBone(t *testing.T) {
...

	{
		...
		matrixes := motion.AnimateBone(fno, model, []string{pmx.INDEX3.Left()}, false)
		{
			...
			if !matrixes.GetItem(pmx.ROOT.String(), fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem(pmx.CENTER.String(), fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem(pmx.GROOVE.String(), fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem(pmx.WAIST.String(), fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem(pmx.UPPER.String(), fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem(pmx.UPPER2.String(), fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem(pmx.UPPER3.String(), fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem(pmx.SHOULDER_P.Left(), fno).Position.PracticallyEquals(expectedPosition, 0.5) {
				t.Errorf("Expected %v, got %v", expectedPosition, matrixes.GetItem(pmx.SHOULDER_P.Left(), fno).Position)
			}
		}
		{
			expectedPosition := &mmath.MVec3{0.324862, 16.470263, 0.419041}
			if !matrixes.GetItem(pmx.SHOULDER.Left(), fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem(pmx.ARM.Left(), fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem(pmx.ARM_TWIST.Left(), fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem(pmx.ELBOW.Left(), fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem(pmx.WRIST_TWIST.Left(), fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem(pmx.WRIST.Left(), fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem(pmx.INDEX1.Left(), fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem(pmx.INDEX2.Left(), fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem(pmx.INDEX3.Left(), fno).Position.PracticallyEquals(expectedPosition, 0.5) {
...
func TestVmdMotion_AnimateBoneLegIk1_Matsu(t *testing.T) {
...

	{
		...
		matrixes := motion.AnimateBone(fno, model, []string{pmx.TOE.Left()}, true)
		{
			...
			if !matrixes.GetItem(pmx.LOWER.String(), fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem(pmx.LEG.Left(), fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem(pmx.KNEE.Left(), fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem(pmx.ANKLE.Left(), fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem(pmx.TOE.Left(), fno).Position.PracticallyEquals(expectedPosition, 0.5) {
...
func TestVmdMotion_AnimateBoneLegIk3_Matsu(t *testing.T) {
...

	{
		...
		{
			expectedPosition := &mmath.MVec3{2.263363, 7.061642, -3.837192}
			if !matrixes.GetItem(pmx.KNEE_D.Left(), fno).Position.PracticallyEquals(expectedPosition, 0.5) {
				t.Errorf("Expected %v, got %v", expectedPosition, matrixes.GetItem(pmx.KNEE.Left(), fno).Position)
			}
		}
		{
			expectedPosition := &mmath.MVec3{1.916109, 1.177077, -1.452845}
			if !matrixes.GetItem(pmx.TOE_EX.Left(), fno).Position.PracticallyEquals(expectedPosition, 0.5) {
				t.Errorf("Expected %v, got %v", expectedPosition, matrixes.GetItem(pmx.TOE.Left(), fno).Position)
			}
		}
	}
...
func TestVmdMotion_AnimateBoneLegIk4_Snow(t *testing.T) {
...

	{
		...
		}
		{
			...
			if !matrixes.GetItem(pmx.LEG.Right(), fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem(pmx.ANKLE.Right(), fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem(pmx.TOE.Right(), fno).Position.PracticallyEquals(expectedPosition, 0.5) {
...
func TestVmdMotion_AnimateBoneLegIk11_Shining_Miku(t *testing.T) {
...

	{
		...
		matrixes := motion.AnimateBone(fno, model, []string{pmx.LEG_IK.Right(), "足首_R_"}, true)
		{
			...
			if !matrixes.GetItem(pmx.LEG_IK.Right(), fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("足首_R_", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
...
func TestVmdMotion_AnimateBoneLegIk13_Lamb(t *testing.T) {
	...
	}
	{
		...
		fno := float32(0)
		{
			...
			if !matrixes.GetItem(pmx.LEG_IK.Left(), fno).Position.PracticallyEquals(expectedPosition, 0.5) {
...
func TestVmdMotion_AnimateBoneArmIk(t *testing.T) {
...

	{
		...
		}
		{
			...
			if !matrixes.GetItem("左人指先", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
...
func TestVmdMotion_AnimateBoneLegIk2(t *testing.T) {
...

	{
		...
		}
		{
			...
			if !matrixes.GetItem("腰", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("下半身", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("下半身先", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("腰キャンセル左", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左足", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左ひざ", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左つま先", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
				t.Errorf("Expected %v, got %v", expectedPosition, matrixes.GetItem("左つま先", fno).Position)
			}
		}
		{
			expectedPosition := &mmath.MVec3{0.90331914, 10.27362702, 1.00949975}
			if !matrixes.GetItem("左足D", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左ひざ2", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左ひざ2先", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
				t.Errorf("Expected %v, got %v", expectedPosition, matrixes.GetItem("左ひざ2先", fno).Position)
			}
		}
		{
			expectedPosition := &mmath.MVec3{0.90331914, 10.27362702, 1.00949975}
			if !matrixes.GetItem("左足y+", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左足yTgt", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
				t.Errorf("Expected %v, got %v", expectedPosition, matrixes.GetItem("左足yTgt", fno).Position)
			}
		}
		{
			expectedPosition := &mmath.MVec3{0.74736036, 9.38409308, 0.58008117}
			if !matrixes.GetItem("左足yIK", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左尻", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
				t.Errorf("Expected %v, got %v", expectedPosition, matrixes.GetItem("左尻", fno).Position)
			}
		}
		{
			expectedPosition := &mmath.MVec3{0.08276818, 5.59348757, -1.24981795}
			if !matrixes.GetItem("左ひざD", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
				t.Errorf("Expected %v, got %v", expectedPosition, matrixes.GetItem("左ひざD", fno).Position)
			}
		}
		{
			expectedPosition := &mmath.MVec3{0.08276818, 5.59348757, -1.24981795}
			if !matrixes.GetItem("左ひざsub", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左ひざsub先", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左ひざD2", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左ひざD2先", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
				t.Errorf("Expected %v, got %v", expectedPosition, matrixes.GetItem("左ひざD2先", fno).Position)
			}
		}
		{
			expectedPosition := &mmath.MVec3{0.12060311, 4.95396153, -1.23761938}
			if !matrixes.GetItem("左ひざD2IK", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左足ゆび", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
				t.Errorf("Expected %v, got %v", expectedPosition, matrixes.GetItem("左足ゆび", fno).Position)
			}
		}
		{
			expectedPosition := &mmath.MVec3{5.63290634e-01, -2.12439821e-04, -3.87768478e-01}
			if !matrixes.GetItem("左つま先D", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
				t.Errorf("Expected %v, got %v", expectedPosition, matrixes.GetItem("左つま先D", fno).Position)
			}
		}
		{
			expectedPosition := &mmath.MVec3{0.90331914, 10.27362702, 1.00949975}
			if !matrixes.GetItem("左足s", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
				t.Errorf("Expected %v, got %v", expectedPosition, matrixes.GetItem("左足s", fno).Position)
			}
		}
		{
			expectedPosition := &mmath.MVec3{0.08276818, 5.59348757, -1.24981795}
			if !matrixes.GetItem("左ひざs", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
				t.Errorf("Expected %v, got %v", expectedPosition, matrixes.GetItem("左ひざs", fno).Position)
			}
		}
		{
			expectedPosition := &mmath.MVec3{1.23779916, 1.28891465, 1.65257835}
			if !matrixes.GetItem("左足首D", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
...
func TestVmdMotion_AnimateBoneArmIk2(t *testing.T) {
...

	{
		...
		{
			expectedPosition := &mmath.MVec3{0.04952335, 11.9671191, 1.06765032}
			if !matrixes.GetItem("上半身", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("上半身2", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右肩", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右肩C", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
				t.Errorf("Expected %v, got %v", expectedPosition, matrixes.GetItem("右肩C", fno).Position)
			}
		}
		{
			expectedPosition := &mmath.MVec3{-0.63104276, 15.44542768, 0.8507726}
			if !matrixes.GetItem("右腕", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右腕捩", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右ひじ", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右手捩", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右手首", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右手先", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
				t.Errorf("Expected %v, got %v", expectedPosition, matrixes.GetItem("右手先", fno).Position)
			}
		}
		{
			expectedPosition := &mmath.MVec3{-0.63104276, 15.44542768, 0.8507726}
			if !matrixes.GetItem("右腕YZ", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右腕YZ先", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右腕YZIK", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
				t.Errorf("Expected %v, got %v", expectedPosition, matrixes.GetItem("右腕YZIK", fno).Position)
			}
		}
		{
			expectedPosition := &mmath.MVec3{-0.63104276, 15.44542768, 0.8507726}
			if !matrixes.GetItem("右腕X", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右腕X先", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右腕XIK", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右腕捩YZ", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右腕捩YZTgt", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右腕捩YZIK", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
				t.Errorf("Expected %v, got %v", expectedPosition, matrixes.GetItem("右腕捩YZIK", fno).Position)
			}
		}
		{
			expectedPosition := &mmath.MVec3{-0.90325538, 14.53727326, 0.79258165}
			if !matrixes.GetItem("右腕捩X", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右腕捩XTgt", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右腕捩XIK", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右ひじYZ", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右ひじYZ先", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右ひじYZIK", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
				t.Errorf("Expected %v, got %v", expectedPosition, matrixes.GetItem("右ひじYZIK", fno).Position)
			}
		}
		{
			expectedPosition := &mmath.MVec3{-1.50499623, 12.52974836, 0.66394738}
			if !matrixes.GetItem("右ひじX", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右ひじX先", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右ひじXIK", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
				t.Errorf("Expected %v, got %v", expectedPosition, matrixes.GetItem("右ひじXIK", fno).Position)
			}
		}
		{
			expectedPosition := &mmath.MVec3{-1.50499623, 12.52974836, 0.66394738}
			if !matrixes.GetItem("右ひじY", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右ひじY先", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
				t.Errorf("Expected %v, got %v", expectedPosition, matrixes.GetItem("右ひじY先", fno).Position)
			}
		}
		{
			expectedPosition := &mmath.MVec3{-1.48334297, 12.74012453, 0.34654052}
			if !matrixes.GetItem("右ひじYIK", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右手捩YZ", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右手捩YZTgt", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右手捩YZIK", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
				t.Errorf("Expected %v, got %v", expectedPosition, matrixes.GetItem("右手捩YZIK", fno).Position)
			}
		}
		{
			expectedPosition := &mmath.MVec3{-1.46845628, 12.88475892, 0.12832214}
			if !matrixes.GetItem("右手捩X", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右手捩XTgt", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右手捩XIK", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右手YZ先", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右手YZIK", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右手X", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右手X先", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右手XIK", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右腕捩1", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右腕捩2", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右腕捩3", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右腕捩4", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右ひじsub", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右ひじsub先", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右手捩1", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右手捩2", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右手捩3", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右手捩4", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右手捩5", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右手捩6", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右手首R", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
				t.Errorf("Expected %v, got %v", expectedPosition, matrixes.GetItem("右手首R", fno).Position)
			}
		}
		{
			expectedPosition := &mmath.MVec3{-1.36500465, 13.89623575, -1.42501008}
			if !matrixes.GetItem("右手首1", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("右手首2", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
...
func TestVmdMotion_AnimateBoneArmIk3(t *testing.T) {
...

	{
		...
		matrixes := motion.AnimateBone(fno, model, nil, true)
		{
			...
			if !matrixes.GetItem("左腕", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左腕捩", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左ひじ", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
				t.Errorf("Expected %v, got %v", expectedPosition, matrixes.GetItem("左ひじ", fno).Position)
			}
		}
		{
			expectedPosition := &mmath.MVec3{1.018832, 15.840092, 0.532239}
			if !matrixes.GetItem("左腕W", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
				t.Errorf("Expected %v, got %v", expectedPosition, matrixes.GetItem("左腕W", fno).Position)
			}
		}
		{
			expectedPosition := &mmath.MVec3{1.353175, 13.181011, -0.334196}
			if !matrixes.GetItem("左腕W先", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
				t.Errorf("Expected %v, got %v", expectedPosition, matrixes.GetItem("左腕W先", fno).Position)
			}
		}
		{
			expectedPosition := &mmath.MVec3{1.353175, 13.181011, -0.334196}
			if !matrixes.GetItem("左腕WIK", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
...
func TestVmdMotion_AnimateBoneArmIk4_DMF(t *testing.T) {
...

	{
		...
		}
		{
			...
			if !matrixes.GetItem("左肩", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左手捩", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左手首", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左手先", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左腕YZ", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左腕YZ先", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左腕YZIK", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左腕X", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左腕X先", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左腕XIK", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左腕捩YZ", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左腕捩YZTgt", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左腕捩YZIK", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左腕捩X", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左腕捩XTgt", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左腕捩XIK", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左ひじYZ", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左ひじYZ先", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左ひじYZIK", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左ひじX", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左ひじX先", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左ひじXIK", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左ひじY", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左ひじY先", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
				t.Errorf("Expected %v, got %v", expectedPosition, matrixes.GetItem("左ひじY先", fno).Position)
			}
		}
		{
			expectedPosition := &mmath.MVec3{9.360781, 13.672805, 1.745905}
			if !matrixes.GetItem("左ひじYIK", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左手捩YZ", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左手捩YZTgt", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左手捩YZIK", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左手捩X", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左手捩XTgt", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左手捩XIK", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左手YZ先", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左手YZIK", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左手X", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左手X先", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左手XIK", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左腕捩1", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左腕捩2", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左腕捩3", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左腕捩4", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左ひじsub", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左ひじsub先", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左手捩1", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左手捩2", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左手捩3", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左手捩4", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左手捩5", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左手捩6", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左手首R", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左手首1", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !matrixes.GetItem("左手首2", fno).Position.PracticallyEquals(expectedPosition, 0.5) {
