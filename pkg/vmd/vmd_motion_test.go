...
func TestVmdMotion_Deform_Exists(t *testing.T) {
...

	{
		...
		fno := int(10.0)
		boneDeltas := motion.BoneFrames.Deform(fno, model, []string{pmx.INDEX3.Left()}, false, nil)
		{
...
func TestVmdMotion_Deform_Lerp(t *testing.T) {
	...
	{
		fno := int(999)
		boneDeltas := motion.BoneFrames.Deform(fno, model, []string{pmx.INDEX3.Left()}, true, nil)
		{
			expectedPosition := &mmath.MVec3{0.0, 0.0, 0.0}
			if !boneDeltas.GetByName((pmx.ROOT.String())).GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.01) {
				t.Errorf("Expected %v, got %v", expectedPosition, boneDeltas.GetByName((pmx.ROOT.String())).GlobalPosition().MMD())
...
func TestVmdMotion_DeformLegIk1_Matsu(t *testing.T) {
	...
	{
		fno := int(29)
		boneDeltas := motion.BoneFrames.Deform(fno, model, []string{pmx.TOE.Left()}, true, nil)
		{
...
func TestVmdMotion_DeformLegIk3_Matsu(t *testing.T) {
...

	{
		...
		fno := int(60)
		boneDeltas := motion.BoneFrames.Deform(fno, model, nil, true, nil)
		{
...
func TestVmdMotion_DeformLegIk4_Snow(t *testing.T) {
...

	{
		...
		fno := int(0)
		boneDeltas := motion.BoneFrames.Deform(fno, model, []string{pmx.TOE.Right()}, true, nil)
		{
...
func TestVmdMotion_DeformLegIk6_SnowOff(t *testing.T) {
...

	{
		// IK OFF
		{
			...
			fno := int(0)
			boneDeltas := motion.BoneFrames.Deform(fno, model, nil, false, nil)
			{
...
func TestVmdMotion_DeformLegIk11_Shining_Miku(t *testing.T) {
...

	{
		...
		fno := int(0)
		boneDeltas := motion.BoneFrames.Deform(fno, model, []string{pmx.LEG_IK.Right(), "足首_R_"}, true, nil)
		{
...
func TestVmdMotion_DeformLegIk13_Lamb(t *testing.T) {
	...
	boneDeltas := motion.BoneFrames.Deform(0, model,
		[]string{pmx.LEG_IK.Right(), pmx.TOE.Right(), pmx.LEG_IK.Left(), pmx.TOE.Left()}, true, nil)
...
func TestVmdMotion_DeformLegIk14_Ballet(t *testing.T) {
...

	{
		...
		fno := int(0)
		boneDeltas := motion.BoneFrames.Deform(fno, model, []string{pmx.LEG_IK.Right(), pmx.TOE.Right()}, true, nil)
		{
...
func TestVmdMotion_DeformLegIk17_Snow(t *testing.T) {
...

	{
		...
		}
		{
			...
			if !boneDeltas.GetByName((pmx.TOE.Right())).GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.06) {
				t.Errorf("Expected %v, got %v", expectedPosition, boneDeltas.GetByName((pmx.TOE.Right())).GlobalPosition().MMD())
			}
		}
	}
...
func TestVmdMotion_DeformLegIk21_FK(t *testing.T) {
...

	{
		...
		fno := int(0)
		boneDeltas := motion.BoneFrames.Deform(fno, model, []string{pmx.TOE.Right()}, false, nil)
		{
...
func TestVmdMotion_DeformLegIk23_Addiction(t *testing.T) {
...

	{
		...
		fno := int(0)
		boneDeltas := motion.BoneFrames.Deform(fno, model, []string{pmx.TOE_IK.Right(), "右つま先"}, true, nil)
		{
...
func TestVmdMotion_DeformArmIk2(t *testing.T) {
...

	{
		...
		}
		{
			...
			if !boneDeltas.GetByName("右手捩").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.01) {
		...
		}
		{
			...
			if !boneDeltas.GetByName("右腕X先").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.05) {
		...
		// 	if !boneDeltas.GetByName("右ひじY先").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.01) {
		...
		}
		{
			...
			if !boneDeltas.GetByName("右手捩YZ").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.01) {
		...
		{
			expectedPosition := &mmath.MVec3{-1.46845628, 12.88475892, 0.12832214}
			if !boneDeltas.GetByName("右手捩X").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.01) {
		...
		// 	if !boneDeltas.GetByName("右ひじsub先").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.01) {
		...
		// 	if !boneDeltas.GetByName("右手捩1").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.01) {
		...
		}
		{
			...
			if !boneDeltas.GetByName("右手首2").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.2) {
...
func TestVmdMotion_DeformArmIk4_DMF(t *testing.T) {
...

	{
		...
		}
		{
			...
			if !boneDeltas.GetByName("左ひじY先").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.5) {
		...
		}
		{
			...
			if !boneDeltas.GetByName("左ひじsub先").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.7) {
...
func TestVmdMotion_DeformLegIk25_Addiction_Wa(t *testing.T) {
	// mlog.SetLevel(mlog.IK_VERBOSE)
...

	{
		...
		fno := int(0)
		boneDeltas := motion.BoneFrames.Deform(fno, model, []string{"右襟先"}, true, nil)
		{
		...
		}
		{
			...
			if !boneDeltas.GetByName("右鎖骨先").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.1) {
		...
		}
		{
			...
			if !boneDeltas.GetByName("右肩Rz検先").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.1) {
		...
		}
		{
			...
			if !boneDeltas.GetByName("右上半身C-B").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.1) {
		...
		}
		{
			...
			if !boneDeltas.GetByName("右襟先").GlobalPosition().MMD().PracticallyEquals(expectedPosition, 0.2) {
