...
func TestVmdMotion_AnimateBoneArmIk2(t *testing.T) {
...

	{
		...
		}
		{
			...
			if !matrixes.GetItem("右ひじY先", fno).Position.PracticallyEquals(expectedPosition, 0.3) {
		...
		}
		{
			...
			if !matrixes.GetItem("右ひじsub先", fno).Position.PracticallyEquals(expectedPosition, 0.2) {
