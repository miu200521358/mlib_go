...
func TestInterpolate(t *testing.T) {
	v1 := mvec4.T{1, 2, 3}
	v2 := &mvec4.T{4, 5, 6} // Pass the address of v2
	t1 := 0.5
	expected := mvec4.T{2.5, 3.5, 4.5}
...
func TestPracticallyEquals(t *testing.T) {
	v1 := mvec4.T{1, 2, 3}
	v2 := mvec4.T{1.000001, 2.000001, 3.000001}
	epsilon := 0.00001
	...
	v3 := mvec4.T{1, 2, 3}
	v4 := mvec4.T{1.0001, 2.0001, 3.0001}
